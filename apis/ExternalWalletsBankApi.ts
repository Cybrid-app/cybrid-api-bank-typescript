...
export interface ListExternalWalletsRequest {
    page?: number;
    perPage?: number;
    owner?: ListRequestOwnerBankModel;
    guid?: string;
    bankGuid?: string;
    customerGuid?: string;
    state?: string;
...
export class ExternalWalletsBankApi extends BaseAPI {
     ...
     */
    listExternalWallets({ page, perPage, owner, guid, bankGuid, customerGuid, state }: ListExternalWalletsRequest): Observable<ExternalWalletListBankModel>
    listExternalWallets({ page, perPage, owner, guid, bankGuid, customerGuid, state }: ListExternalWalletsRequest, opts?: OperationOpts): Observable<AjaxResponse<ExternalWalletListBankModel>>
    listExternalWallets({ page, perPage, owner, guid, bankGuid, customerGuid, state }: ListExternalWalletsRequest, opts?: OperationOpts): Observable<ExternalWalletListBankModel | AjaxResponse<ExternalWalletListBankModel>> {
