...
export interface UpdateExternalWalletRequest {
    externalWalletGuid: string;
    patchExternalWalletBankModel: PatchExternalWalletBankModel;
}
...
export class ExternalWalletsBankApi extends BaseAPI {
     ...
     */
    listExternalWallets({ page, perPage, owner, guid, bankGuid, customerGuid, counterpartyGuid, asset, state }: ListExternalWalletsRequest): Observable<ExternalWalletListBankModel>
    listExternalWallets({ page, perPage, owner, guid, bankGuid, customerGuid, counterpartyGuid, asset, state }: ListExternalWalletsRequest, opts?: OperationOpts): Observable<AjaxResponse<ExternalWalletListBankModel>>
    listExternalWallets({ page, perPage, owner, guid, bankGuid, customerGuid, counterpartyGuid, asset, state }: ListExternalWalletsRequest, opts?: OperationOpts): Observable<ExternalWalletListBankModel | AjaxResponse<ExternalWalletListBankModel>> {
     ...
     */
    updateExternalWallet({ externalWalletGuid, patchExternalWalletBankModel }: UpdateExternalWalletRequest): Observable<ExternalWalletBankModel>
    updateExternalWallet({ externalWalletGuid, patchExternalWalletBankModel }: UpdateExternalWalletRequest, opts?: OperationOpts): Observable<AjaxResponse<ExternalWalletBankModel>>
    updateExternalWallet({ externalWalletGuid, patchExternalWalletBankModel }: UpdateExternalWalletRequest, opts?: OperationOpts): Observable<ExternalWalletBankModel | AjaxResponse<ExternalWalletBankModel>> {
        throwIfNullOrUndefined(externalWalletGuid, 'externalWalletGuid', 'updateExternalWallet');
        throwIfNullOrUndefined(patchExternalWalletBankModel, 'patchExternalWalletBankModel', 'updateExternalWallet');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['external_wallets:write'])
                    : this.configuration.accessToken }
                : undefined
            ),
        };
        ...
        return this.request<ExternalWalletBankModel>({
            ...
            method: 'PATCH',
            headers,
            body: patchExternalWalletBankModel,
        }, opts?.responseOpts);
    };
