...
export class ExternalWalletsBankApi extends BaseAPI {
     ...
     */
    listExternalWallets({ page, perPage, owner, guid, bankGuid, customerGuid, asset, state }: ListExternalWalletsRequest): Observable<ExternalWalletListBankModel>
    listExternalWallets({ page, perPage, owner, guid, bankGuid, customerGuid, asset, state }: ListExternalWalletsRequest, opts?: OperationOpts): Observable<AjaxResponse<ExternalWalletListBankModel>>
    listExternalWallets({ page, perPage, owner, guid, bankGuid, customerGuid, asset, state }: ListExternalWalletsRequest, opts?: OperationOpts): Observable<ExternalWalletListBankModel | AjaxResponse<ExternalWalletListBankModel>> {
