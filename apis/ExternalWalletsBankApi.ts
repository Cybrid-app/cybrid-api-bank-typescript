...
export class ExternalWalletsBankApi extends BaseAPI {
     ...
     */
    listExternalWallets({ page, perPage, guid, bankGuid, customerGuid, state }: ListExternalWalletsRequest): Observable<ExternalWalletListBankModel>
    listExternalWallets({ page, perPage, guid, bankGuid, customerGuid, state }: ListExternalWalletsRequest, opts?: OperationOpts): Observable<AjaxResponse<ExternalWalletListBankModel>>
    listExternalWallets({ page, perPage, guid, bankGuid, customerGuid, state }: ListExternalWalletsRequest, opts?: OperationOpts): Observable<ExternalWalletListBankModel | AjaxResponse<ExternalWalletListBankModel>> {
