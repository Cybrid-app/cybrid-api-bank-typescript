 ...
 * no description
 */
export class PricesBankApi extends BaseAPI {
     ...
     * Get Price
     */
    listPrices({ symbol }: ListPricesRequest): Observable<Array<SymbolPriceBankModel>>
    listPrices({ symbol }: ListPricesRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<SymbolPriceBankModel>>>
    listPrices({ symbol }: ListPricesRequest, opts?: OperationOpts): Observable<Array<SymbolPriceBankModel> | RawAjaxResponse<Array<SymbolPriceBankModel>>> {
        ...
        return this.request<Array<SymbolPriceBankModel>>({
            url: '/api/prices',
            method: 'GET',
            headers,
            query,
