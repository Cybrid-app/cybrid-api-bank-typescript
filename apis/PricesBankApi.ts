...
export class PricesBankApi extends BaseAPI {
    ...
    listPrices({ symbol }: ListPricesRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<SymbolPriceBankModel>>>
    listPrices({ symbol }: ListPricesRequest, opts?: OperationOpts): Observable<Array<SymbolPriceBankModel> | AjaxResponse<Array<SymbolPriceBankModel>>> {
