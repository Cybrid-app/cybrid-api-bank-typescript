...
export class TransfersBankApi extends BaseAPI {
     ...
     * Get transfers list
     */
    listTransfers({ page, perPage, guid, bankGuid, customerGuid, accountGuid, state }: ListTransfersRequest): Observable<TransferListBankModel>
    listTransfers({ page, perPage, guid, bankGuid, customerGuid, accountGuid, state }: ListTransfersRequest, opts?: OperationOpts): Observable<AjaxResponse<TransferListBankModel>>
    listTransfers({ page, perPage, guid, bankGuid, customerGuid, accountGuid, state }: ListTransfersRequest, opts?: OperationOpts): Observable<TransferListBankModel | AjaxResponse<TransferListBankModel>> {
