...
export class TransfersBankApi extends BaseAPI {
     ...
     * Get transfers list
     */
    listTransfers({ page, perPage, guid, transferType, bankGuid, customerGuid, accountGuid, state, label, createdAtGte, createdAtLt }: ListTransfersRequest): Observable<TransferListBankModel>
    listTransfers({ page, perPage, guid, transferType, bankGuid, customerGuid, accountGuid, state, label, createdAtGte, createdAtLt }: ListTransfersRequest, opts?: OperationOpts): Observable<AjaxResponse<TransferListBankModel>>
    listTransfers({ page, perPage, guid, transferType, bankGuid, customerGuid, accountGuid, state, label, createdAtGte, createdAtLt }: ListTransfersRequest, opts?: OperationOpts): Observable<TransferListBankModel | AjaxResponse<TransferListBankModel>> {
