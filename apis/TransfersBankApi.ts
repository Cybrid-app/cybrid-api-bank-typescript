...
export class TransfersBankApi extends BaseAPI {
     ...
     * Cancel Transfer
     */
    cancelTransfer({ transferGuid, acceptVersion }: CancelTransferRequest): Observable<TransferBankModel>
    cancelTransfer({ transferGuid, acceptVersion }: CancelTransferRequest, opts?: OperationOpts): Observable<AjaxResponse<TransferBankModel>>
    cancelTransfer({ transferGuid, acceptVersion }: CancelTransferRequest, opts?: OperationOpts): Observable<TransferBankModel | AjaxResponse<TransferBankModel>> {
        throwIfNullOrUndefined(transferGuid, 'transferGuid', 'cancelTransfer');
        throwIfNullOrUndefined(acceptVersion, 'acceptVersion', 'cancelTransfer');

        const headers: HttpHeaders = {
            ...(acceptVersion != null ? { 'Accept-Version': String(acceptVersion) } : undefined),
