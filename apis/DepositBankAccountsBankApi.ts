...
export interface DeleteDepositBankAccountRequest {
...
export interface UpdateDepositBankAccountRequest {
    depositBankAccountGuid: string;
    patchDepositBankAccountBankModel: PatchDepositBankAccountBankModel;
}
...
export class DepositBankAccountsBankApi extends BaseAPI {
     ...
     */
    deleteDepositBankAccount({ depositBankAccountGuid }: DeleteDepositBankAccountRequest): Observable<DepositBankAccountBankModel>
    deleteDepositBankAccount({ depositBankAccountGuid }: DeleteDepositBankAccountRequest, opts?: OperationOpts): Observable<AjaxResponse<DepositBankAccountBankModel>>
    deleteDepositBankAccount({ depositBankAccountGuid }: DeleteDepositBankAccountRequest, opts?: OperationOpts): Observable<DepositBankAccountBankModel | AjaxResponse<DepositBankAccountBankModel>> {
        throwIfNullOrUndefined(depositBankAccountGuid, 'depositBankAccountGuid', 'deleteDepositBankAccount');
     ...
     */
    listDepositBankAccounts({ page, perPage, guid, bankGuid, customerGuid, label, uniqueMemoId, type, state, parentDepositBankAccountGuid }: ListDepositBankAccountsRequest): Observable<DepositBankAccountListBankModel>
    listDepositBankAccounts({ page, perPage, guid, bankGuid, customerGuid, label, uniqueMemoId, type, state, parentDepositBankAccountGuid }: ListDepositBankAccountsRequest, opts?: OperationOpts): Observable<AjaxResponse<DepositBankAccountListBankModel>>
    listDepositBankAccounts({ page, perPage, guid, bankGuid, customerGuid, label, uniqueMemoId, type, state, parentDepositBankAccountGuid }: ListDepositBankAccountsRequest, opts?: OperationOpts): Observable<DepositBankAccountListBankModel | AjaxResponse<DepositBankAccountListBankModel>> {
     ...
     */
    updateDepositBankAccount({ depositBankAccountGuid, patchDepositBankAccountBankModel }: UpdateDepositBankAccountRequest): Observable<DepositBankAccountBankModel>
    updateDepositBankAccount({ depositBankAccountGuid, patchDepositBankAccountBankModel }: UpdateDepositBankAccountRequest, opts?: OperationOpts): Observable<AjaxResponse<DepositBankAccountBankModel>>
    updateDepositBankAccount({ depositBankAccountGuid, patchDepositBankAccountBankModel }: UpdateDepositBankAccountRequest, opts?: OperationOpts): Observable<DepositBankAccountBankModel | AjaxResponse<DepositBankAccountBankModel>> {
        throwIfNullOrUndefined(depositBankAccountGuid, 'depositBankAccountGuid', 'updateDepositBankAccount');
        throwIfNullOrUndefined(patchDepositBankAccountBankModel, 'patchDepositBankAccountBankModel', 'updateDepositBankAccount');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['deposit_bank_accounts:write'])
                    : this.configuration.accessToken }
                : undefined
            ),
        };
        ...
        return this.request<DepositBankAccountBankModel>({
            ...
            method: 'PATCH',
            headers,
            body: patchDepositBankAccountBankModel,
        }, opts?.responseOpts);
    };
