...
export class DepositBankAccountsBankApi extends BaseAPI {
     ...
     */
    listDepositBankAccounts({ page, perPage, guid, bankGuid, customerGuid, label }: ListDepositBankAccountsRequest): Observable<DepositBankAccountListBankModel>
    listDepositBankAccounts({ page, perPage, guid, bankGuid, customerGuid, label }: ListDepositBankAccountsRequest, opts?: OperationOpts): Observable<AjaxResponse<DepositBankAccountListBankModel>>
    listDepositBankAccounts({ page, perPage, guid, bankGuid, customerGuid, label }: ListDepositBankAccountsRequest, opts?: OperationOpts): Observable<DepositBankAccountListBankModel | AjaxResponse<DepositBankAccountListBankModel>> {
