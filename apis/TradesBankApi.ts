...
export class TradesBankApi extends BaseAPI {
    ...
    createTrade({ postTradeBankModel }: CreateTradeRequest, opts?: OperationOpts): Observable<RawAjaxResponse<TradeBankModel>>
    createTrade({ postTradeBankModel }: CreateTradeRequest, opts?: OperationOpts): Observable<TradeBankModel | RawAjaxResponse<TradeBankModel>> {
    ...
    getTrade({ tradeGuid }: GetTradeRequest, opts?: OperationOpts): Observable<RawAjaxResponse<TradeBankModel>>
    getTrade({ tradeGuid }: GetTradeRequest, opts?: OperationOpts): Observable<TradeBankModel | RawAjaxResponse<TradeBankModel>> {
     ...
     * Get trades list
     */
    listTrades({ customerGuid, accountGuid, page, perPage, guid }: ListTradesRequest): Observable<TradeListBankModel>
    listTrades({ customerGuid, accountGuid, page, perPage, guid }: ListTradesRequest, opts?: OperationOpts): Observable<RawAjaxResponse<TradeListBankModel>>
    listTrades({ customerGuid, accountGuid, page, perPage, guid }: ListTradesRequest, opts?: OperationOpts): Observable<TradeListBankModel | RawAjaxResponse<TradeListBankModel>> {
        throwIfNullOrUndefined(customerGuid, 'customerGuid', 'listTrades');
        throwIfNullOrUndefined(accountGuid, 'accountGuid', 'listTrades');
