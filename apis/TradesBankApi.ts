...
export class TradesBankApi extends BaseAPI {
     ...
     * Get trades list
     */
    listTrades({ page, perPage, guid, bankGuid, customerGuid, accountGuid, state, label, createdAtGte, createdAtLt, updatedAtGte, updatedAtLt }: ListTradesRequest): Observable<TradeListBankModel>
    listTrades({ page, perPage, guid, bankGuid, customerGuid, accountGuid, state, label, createdAtGte, createdAtLt, updatedAtGte, updatedAtLt }: ListTradesRequest, opts?: OperationOpts): Observable<AjaxResponse<TradeListBankModel>>
    listTrades({ page, perPage, guid, bankGuid, customerGuid, accountGuid, state, label, createdAtGte, createdAtLt, updatedAtGte, updatedAtLt }: ListTradesRequest, opts?: OperationOpts): Observable<TradeListBankModel | AjaxResponse<TradeListBankModel>> {
