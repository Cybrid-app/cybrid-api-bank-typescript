...
export class TradesBankApi extends BaseAPI {
    ...
    listTrades({ page, perPage, guid, bankGuid, customerGuid, accountGuid }: ListTradesRequest, opts?: OperationOpts): Observable<AjaxResponse<TradeListBankModel>>
    listTrades({ page, perPage, guid, bankGuid, customerGuid, accountGuid }: ListTradesRequest, opts?: OperationOpts): Observable<TradeListBankModel | AjaxResponse<TradeListBankModel>> {
