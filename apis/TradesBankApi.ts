...
export class TradesBankApi extends BaseAPI {
     ...
     * Get trades list
     */
    listTrades({ page, perPage, guid, bankGuid, customerGuid, accountGuid }: ListTradesRequest): Observable<TradeListBankModel>
    listTrades({ page, perPage, guid, bankGuid, customerGuid, accountGuid }: ListTradesRequest, opts?: OperationOpts): Observable<RawAjaxResponse<TradeListBankModel>>
    listTrades({ page, perPage, guid, bankGuid, customerGuid, accountGuid }: ListTradesRequest, opts?: OperationOpts): Observable<TradeListBankModel | RawAjaxResponse<TradeListBankModel>> {
