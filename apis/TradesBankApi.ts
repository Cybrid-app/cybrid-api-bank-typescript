...
export class TradesBankApi extends BaseAPI {
     ...
     * Get trades list
     */
    listTrades({ page, perPage, guid, bankGuid, customerGuid, accountGuid, state }: ListTradesRequest): Observable<TradeListBankModel>
    listTrades({ page, perPage, guid, bankGuid, customerGuid, accountGuid, state }: ListTradesRequest, opts?: OperationOpts): Observable<AjaxResponse<TradeListBankModel>>
    listTrades({ page, perPage, guid, bankGuid, customerGuid, accountGuid, state }: ListTradesRequest, opts?: OperationOpts): Observable<TradeListBankModel | AjaxResponse<TradeListBankModel>> {
