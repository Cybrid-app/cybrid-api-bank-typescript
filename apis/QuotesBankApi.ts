...
export class QuotesBankApi extends BaseAPI {
    ...
    listQuotes({ page, perPage, guid, bankGuid, customerGuid }: ListQuotesRequest, opts?: OperationOpts): Observable<RawAjaxResponse<QuoteListBankModel>>
    listQuotes({ page, perPage, guid, bankGuid, customerGuid }: ListQuotesRequest, opts?: OperationOpts): Observable<QuoteListBankModel | RawAjaxResponse<QuoteListBankModel>> {
