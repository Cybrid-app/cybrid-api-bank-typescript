...
export class QuotesBankApi extends BaseAPI {
     ...
     * Get quotes list
     */
    listQuotes({ page, perPage, guid, productType, bankGuid, customerGuid, side }: ListQuotesRequest): Observable<QuoteListBankModel>
    listQuotes({ page, perPage, guid, productType, bankGuid, customerGuid, side }: ListQuotesRequest, opts?: OperationOpts): Observable<AjaxResponse<QuoteListBankModel>>
    listQuotes({ page, perPage, guid, productType, bankGuid, customerGuid, side }: ListQuotesRequest, opts?: OperationOpts): Observable<QuoteListBankModel | AjaxResponse<QuoteListBankModel>> {
