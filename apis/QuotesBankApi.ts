...
export class QuotesBankApi extends BaseAPI {
     ...
     * Get quotes list
     */
    listQuotes({ page, perPage, guid, productType, bankGuid, customerGuid }: ListQuotesRequest): Observable<QuoteListBankModel>
    listQuotes({ page, perPage, guid, productType, bankGuid, customerGuid }: ListQuotesRequest, opts?: OperationOpts): Observable<AjaxResponse<QuoteListBankModel>>
    listQuotes({ page, perPage, guid, productType, bankGuid, customerGuid }: ListQuotesRequest, opts?: OperationOpts): Observable<QuoteListBankModel | AjaxResponse<QuoteListBankModel>> {
