...
export class VerificationKeysBankApi extends BaseAPI {
    ...
    createVerificationKey({ postVerificationKeyBankModel }: CreateVerificationKeyRequest, opts?: OperationOpts): Observable<RawAjaxResponse<VerificationKeyBankModel>>
    createVerificationKey({ postVerificationKeyBankModel }: CreateVerificationKeyRequest, opts?: OperationOpts): Observable<VerificationKeyBankModel | RawAjaxResponse<VerificationKeyBankModel>> {
    ...
    getVerificationKey({ verificationKeyGuid }: GetVerificationKeyRequest, opts?: OperationOpts): Observable<RawAjaxResponse<VerificationKeyBankModel>>
    getVerificationKey({ verificationKeyGuid }: GetVerificationKeyRequest, opts?: OperationOpts): Observable<VerificationKeyBankModel | RawAjaxResponse<VerificationKeyBankModel>> {
    ...
    listVerificationKeys({ page, perPage }: ListVerificationKeysRequest, opts?: OperationOpts): Observable<RawAjaxResponse<VerificationKeyListBankModel>>
    listVerificationKeys({ page, perPage }: ListVerificationKeysRequest, opts?: OperationOpts): Observable<VerificationKeyListBankModel | RawAjaxResponse<VerificationKeyListBankModel>> {
