...
export class CustomersBankApi extends BaseAPI {
    ...
    getCustomer({ customerGuid }: GetCustomerRequest, opts?: OperationOpts): Observable<RawAjaxResponse<CustomerBankModel>>
    getCustomer({ customerGuid }: GetCustomerRequest, opts?: OperationOpts): Observable<CustomerBankModel | RawAjaxResponse<CustomerBankModel>> {
     ...
     * Get customers list
     */
    listCustomers({ page, perPage }: ListCustomersRequest): Observable<CustomerListBankModel>
    listCustomers({ page, perPage }: ListCustomersRequest, opts?: OperationOpts): Observable<RawAjaxResponse<CustomerListBankModel>>
    listCustomers({ page, perPage }: ListCustomersRequest, opts?: OperationOpts): Observable<CustomerListBankModel | RawAjaxResponse<CustomerListBankModel>> {
