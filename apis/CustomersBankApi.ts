...
export class CustomersBankApi extends BaseAPI {
    ...
    createCustomer({ postCustomerBankModel }: CreateCustomerRequest, opts?: OperationOpts): Observable<RawAjaxResponse<CustomerBankModel>>
    createCustomer({ postCustomerBankModel }: CreateCustomerRequest, opts?: OperationOpts): Observable<CustomerBankModel | RawAjaxResponse<CustomerBankModel>> {
     ...
     * Get Customer
     */
    getCustomer({ customerGuid, bankGuid }: GetCustomerRequest): Observable<CustomerBankModel>
    getCustomer({ customerGuid, bankGuid }: GetCustomerRequest, opts?: OperationOpts): Observable<RawAjaxResponse<CustomerBankModel>>
    getCustomer({ customerGuid, bankGuid }: GetCustomerRequest, opts?: OperationOpts): Observable<CustomerBankModel | RawAjaxResponse<CustomerBankModel>> {
    ...
    listCustomers({ page, perPage, bankGuid, guid }: ListCustomersRequest, opts?: OperationOpts): Observable<RawAjaxResponse<CustomerListBankModel>>
    listCustomers({ page, perPage, bankGuid, guid }: ListCustomersRequest, opts?: OperationOpts): Observable<CustomerListBankModel | RawAjaxResponse<CustomerListBankModel>> {
