...
export class CustomersBankApi extends BaseAPI {
     ...
     * Get customers list
     */
    listCustomers({ page, perPage, type, bankGuid, guid, label }: ListCustomersRequest): Observable<CustomerListBankModel>
    listCustomers({ page, perPage, type, bankGuid, guid, label }: ListCustomersRequest, opts?: OperationOpts): Observable<AjaxResponse<CustomerListBankModel>>
    listCustomers({ page, perPage, type, bankGuid, guid, label }: ListCustomersRequest, opts?: OperationOpts): Observable<CustomerListBankModel | AjaxResponse<CustomerListBankModel>> {
