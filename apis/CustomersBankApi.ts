...
export class CustomersBankApi extends BaseAPI {
     ...
     * Get Customer
     */
    getCustomer({ customerGuid, includePii }: GetCustomerRequest): Observable<CustomerBankModel>
    getCustomer({ customerGuid, includePii }: GetCustomerRequest, opts?: OperationOpts): Observable<AjaxResponse<CustomerBankModel>>
    getCustomer({ customerGuid, includePii }: GetCustomerRequest, opts?: OperationOpts): Observable<CustomerBankModel | AjaxResponse<CustomerBankModel>> {
     ...
     * Get customers list
     */
    listCustomers({ page, perPage, type, bankGuid, guid, label, includePii }: ListCustomersRequest): Observable<CustomerListBankModel>
    listCustomers({ page, perPage, type, bankGuid, guid, label, includePii }: ListCustomersRequest, opts?: OperationOpts): Observable<AjaxResponse<CustomerListBankModel>>
    listCustomers({ page, perPage, type, bankGuid, guid, label, includePii }: ListCustomersRequest, opts?: OperationOpts): Observable<CustomerListBankModel | AjaxResponse<CustomerListBankModel>> {
     ...
     * Patch Customer
     */
    updateCustomer({ customerGuid, patchCustomerBankModel }: UpdateCustomerRequest): Observable<CustomerBankModel>
    updateCustomer({ customerGuid, patchCustomerBankModel }: UpdateCustomerRequest, opts?: OperationOpts): Observable<AjaxResponse<CustomerBankModel>>
    updateCustomer({ customerGuid, patchCustomerBankModel }: UpdateCustomerRequest, opts?: OperationOpts): Observable<CustomerBankModel | AjaxResponse<CustomerBankModel>> {
        throwIfNullOrUndefined(customerGuid, 'customerGuid', 'updateCustomer');
        throwIfNullOrUndefined(patchCustomerBankModel, 'patchCustomerBankModel', 'updateCustomer');
