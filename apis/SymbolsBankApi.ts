...
export class SymbolsBankApi extends BaseAPI {
    ...
    listSymbols(opts?: OperationOpts): Observable<RawAjaxResponse<Array<string>>>
    listSymbols(opts?: OperationOpts): Observable<Array<string> | RawAjaxResponse<Array<string>>> {
