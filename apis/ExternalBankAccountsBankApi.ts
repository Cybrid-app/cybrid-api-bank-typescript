...
export class ExternalBankAccountsBankApi extends BaseAPI {
     ...
     */
    listExternalBankAccounts({ page, perPage, guid, bankGuid, customerGuid, asset, state }: ListExternalBankAccountsRequest): Observable<ExternalBankAccountListBankModel>
    listExternalBankAccounts({ page, perPage, guid, bankGuid, customerGuid, asset, state }: ListExternalBankAccountsRequest, opts?: OperationOpts): Observable<AjaxResponse<ExternalBankAccountListBankModel>>
    listExternalBankAccounts({ page, perPage, guid, bankGuid, customerGuid, asset, state }: ListExternalBankAccountsRequest, opts?: OperationOpts): Observable<ExternalBankAccountListBankModel | AjaxResponse<ExternalBankAccountListBankModel>> {
