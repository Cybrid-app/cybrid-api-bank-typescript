...
export class TradingConfigurationsBankApi extends BaseAPI {
    ...
    createTradingConfiguration({ postTradingConfigurationBankModel }: CreateTradingConfigurationRequest, opts?: OperationOpts): Observable<AjaxResponse<TradingConfigurationBankModel>>
    createTradingConfiguration({ postTradingConfigurationBankModel }: CreateTradingConfigurationRequest, opts?: OperationOpts): Observable<TradingConfigurationBankModel | AjaxResponse<TradingConfigurationBankModel>> {
    ...
    getTradingConfiguration({ tradingConfigurationGuid }: GetTradingConfigurationRequest, opts?: OperationOpts): Observable<AjaxResponse<TradingConfigurationBankModel>>
    getTradingConfiguration({ tradingConfigurationGuid }: GetTradingConfigurationRequest, opts?: OperationOpts): Observable<TradingConfigurationBankModel | AjaxResponse<TradingConfigurationBankModel>> {
    ...
    listTradingConfigurations({ page, perPage }: ListTradingConfigurationsRequest, opts?: OperationOpts): Observable<AjaxResponse<TradingConfigurationListBankModel>>
    listTradingConfigurations({ page, perPage }: ListTradingConfigurationsRequest, opts?: OperationOpts): Observable<TradingConfigurationListBankModel | AjaxResponse<TradingConfigurationListBankModel>> {
