...
export class AccountsBankApi extends BaseAPI {
     ...
     * List Accounts
     */
    listAccounts({ page, perPage, guid, customerGuid }: ListAccountsRequest): Observable<AccountListBankModel>
    listAccounts({ page, perPage, guid, customerGuid }: ListAccountsRequest, opts?: OperationOpts): Observable<RawAjaxResponse<AccountListBankModel>>
    listAccounts({ page, perPage, guid, customerGuid }: ListAccountsRequest, opts?: OperationOpts): Observable<AccountListBankModel | RawAjaxResponse<AccountListBankModel>> {
