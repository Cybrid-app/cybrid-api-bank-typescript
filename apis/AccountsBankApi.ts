...
export class AccountsBankApi extends BaseAPI {
     ...
     * List Accounts
     */
    listAccounts({ page, perPage, guid, type, bankGuid, customerGuid }: ListAccountsRequest): Observable<AccountListBankModel>
    listAccounts({ page, perPage, guid, type, bankGuid, customerGuid }: ListAccountsRequest, opts?: OperationOpts): Observable<AjaxResponse<AccountListBankModel>>
    listAccounts({ page, perPage, guid, type, bankGuid, customerGuid }: ListAccountsRequest, opts?: OperationOpts): Observable<AccountListBankModel | AjaxResponse<AccountListBankModel>> {
