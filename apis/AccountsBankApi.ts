...
export class AccountsBankApi extends BaseAPI {
    ...
    listAccounts({ page, perPage, guid, bankGuid, customerGuid }: ListAccountsRequest, opts?: OperationOpts): Observable<AjaxResponse<AccountListBankModel>>
    listAccounts({ page, perPage, guid, bankGuid, customerGuid }: ListAccountsRequest, opts?: OperationOpts): Observable<AccountListBankModel | AjaxResponse<AccountListBankModel>> {
