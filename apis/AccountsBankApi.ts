...
export class AccountsBankApi extends BaseAPI {
    ...
    createAccount({ postAccountBankModel }: CreateAccountRequest, opts?: OperationOpts): Observable<RawAjaxResponse<AccountBankModel>>
    createAccount({ postAccountBankModel }: CreateAccountRequest, opts?: OperationOpts): Observable<AccountBankModel | RawAjaxResponse<AccountBankModel>> {
    ...
    getAccount({ accountGuid }: GetAccountRequest, opts?: OperationOpts): Observable<RawAjaxResponse<AccountBankModel>>
    getAccount({ accountGuid }: GetAccountRequest, opts?: OperationOpts): Observable<AccountBankModel | RawAjaxResponse<AccountBankModel>> {
     ...
     * List Accounts
     */
    listAccounts({ page, perPage, guid, bankGuid, customerGuid }: ListAccountsRequest): Observable<AccountListBankModel>
    listAccounts({ page, perPage, guid, bankGuid, customerGuid }: ListAccountsRequest, opts?: OperationOpts): Observable<RawAjaxResponse<AccountListBankModel>>
    listAccounts({ page, perPage, guid, bankGuid, customerGuid }: ListAccountsRequest, opts?: OperationOpts): Observable<AccountListBankModel | RawAjaxResponse<AccountListBankModel>> {
