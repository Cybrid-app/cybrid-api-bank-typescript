...
export interface UpdateAccountRequest {
    accountGuid: string;
    patchAccountBankModel: PatchAccountBankModel;
}
...
export class AccountsBankApi extends BaseAPI {
     ...
     * Get Account
     */
    getAccount({ accountGuid, includeBalances }: GetAccountRequest): Observable<AccountBankModel>
    getAccount({ accountGuid, includeBalances }: GetAccountRequest, opts?: OperationOpts): Observable<AjaxResponse<AccountBankModel>>
    getAccount({ accountGuid, includeBalances }: GetAccountRequest, opts?: OperationOpts): Observable<AccountBankModel | AjaxResponse<AccountBankModel>> {
     ...
     * List Accounts
     */
    listAccounts({ page, perPage, owner, guid, type, bankGuid, customerGuid, label, includeBalances }: ListAccountsRequest): Observable<AccountListBankModel>
    listAccounts({ page, perPage, owner, guid, type, bankGuid, customerGuid, label, includeBalances }: ListAccountsRequest, opts?: OperationOpts): Observable<AjaxResponse<AccountListBankModel>>
    listAccounts({ page, perPage, owner, guid, type, bankGuid, customerGuid, label, includeBalances }: ListAccountsRequest, opts?: OperationOpts): Observable<AccountListBankModel | AjaxResponse<AccountListBankModel>> {
     ...
     * Patch Account
     */
    updateAccount({ accountGuid, patchAccountBankModel }: UpdateAccountRequest): Observable<AccountBankModel>
    updateAccount({ accountGuid, patchAccountBankModel }: UpdateAccountRequest, opts?: OperationOpts): Observable<AjaxResponse<AccountBankModel>>
    updateAccount({ accountGuid, patchAccountBankModel }: UpdateAccountRequest, opts?: OperationOpts): Observable<AccountBankModel | AjaxResponse<AccountBankModel>> {
        throwIfNullOrUndefined(accountGuid, 'accountGuid', 'updateAccount');
        throwIfNullOrUndefined(patchAccountBankModel, 'patchAccountBankModel', 'updateAccount');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['accounts:write'])
                    : this.configuration.accessToken }
                : undefined
            ),
        };
