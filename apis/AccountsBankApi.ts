...
export class AccountsBankApi extends BaseAPI {
     ...
     * List Accounts
     */
    listAccounts({ page, perPage, guid }: ListAccountsRequest): Observable<AccountListBankModel>
    listAccounts({ page, perPage, guid }: ListAccountsRequest, opts?: OperationOpts): Observable<RawAjaxResponse<AccountListBankModel>>
    listAccounts({ page, perPage, guid }: ListAccountsRequest, opts?: OperationOpts): Observable<AccountListBankModel | RawAjaxResponse<AccountListBankModel>> {
