 ...
 * no description
 */
export class FilesBankApi extends BaseAPI {
     ...
     * Create File
     */
    createFile({ postFileBankModel }: CreateFileRequest): Observable<PlatformFileBankModel>
    createFile({ postFileBankModel }: CreateFileRequest, opts?: OperationOpts): Observable<AjaxResponse<PlatformFileBankModel>>
    createFile({ postFileBankModel }: CreateFileRequest, opts?: OperationOpts): Observable<PlatformFileBankModel | AjaxResponse<PlatformFileBankModel>> {
        throwIfNullOrUndefined(postFileBankModel, 'postFileBankModel', 'createFile');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['files:execute'])
     ...
     * Get File
     */
    getFile({ fileGuid, includeDownloadUrl }: GetFileRequest): Observable<PlatformFileBankModel>
    getFile({ fileGuid, includeDownloadUrl }: GetFileRequest, opts?: OperationOpts): Observable<AjaxResponse<PlatformFileBankModel>>
    getFile({ fileGuid, includeDownloadUrl }: GetFileRequest, opts?: OperationOpts): Observable<PlatformFileBankModel | AjaxResponse<PlatformFileBankModel>> {
        throwIfNullOrUndefined(fileGuid, 'fileGuid', 'getFile');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['files:read'])
                    : this.configuration.accessToken }
                : undefined
            ),
        };
        ...
        if (includeDownloadUrl != null) { query['include_download_url'] = includeDownloadUrl; }

        return this.request<PlatformFileBankModel>({
            url: '/api/files/{file_guid}'.replace('{file_guid}', encodeURI(fileGuid)),
            method: 'GET',
            headers,
            query,
        }, opts?.responseOpts);
     ...
     * List Files
     */
    listFiles({ page, perPage, guid, type, state, bankGuid, customerGuid }: ListFilesRequest): Observable<PlatformFileListBankModel>
    listFiles({ page, perPage, guid, type, state, bankGuid, customerGuid }: ListFilesRequest, opts?: OperationOpts): Observable<AjaxResponse<PlatformFileListBankModel>>
    listFiles({ page, perPage, guid, type, state, bankGuid, customerGuid }: ListFilesRequest, opts?: OperationOpts): Observable<PlatformFileListBankModel | AjaxResponse<PlatformFileListBankModel>> {
        ...
        return this.request<PlatformFileListBankModel>({
            url: '/api/files',
            method: 'GET',
            headers,
            query,
