...
export class BanksBankApi extends BaseAPI {
    ...
    listBanks({ page, perPage, guid }: ListBanksRequest, opts?: OperationOpts): Observable<RawAjaxResponse<BankListBankModel>>
    listBanks({ page, perPage, guid }: ListBanksRequest, opts?: OperationOpts): Observable<BankListBankModel | RawAjaxResponse<BankListBankModel>> {
