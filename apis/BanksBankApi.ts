...
export class BanksBankApi extends BaseAPI {
     ...
     * Get banks list
     */
    listBanks({ page, perPage, type, guid }: ListBanksRequest): Observable<BankListBankModel>
    listBanks({ page, perPage, type, guid }: ListBanksRequest, opts?: OperationOpts): Observable<AjaxResponse<BankListBankModel>>
    listBanks({ page, perPage, type, guid }: ListBanksRequest, opts?: OperationOpts): Observable<BankListBankModel | AjaxResponse<BankListBankModel>> {
