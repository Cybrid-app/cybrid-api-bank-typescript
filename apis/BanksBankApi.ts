...
export class BanksBankApi extends BaseAPI {
    ...
    createBank({ postBankBankModel }: CreateBankRequest, opts?: OperationOpts): Observable<RawAjaxResponse<BankBankModel>>
    createBank({ postBankBankModel }: CreateBankRequest, opts?: OperationOpts): Observable<BankBankModel | RawAjaxResponse<BankBankModel>> {
    ...
    getBank({ bankGuid }: GetBankRequest, opts?: OperationOpts): Observable<RawAjaxResponse<BankBankModel>>
    getBank({ bankGuid }: GetBankRequest, opts?: OperationOpts): Observable<BankBankModel | RawAjaxResponse<BankBankModel>> {
     ...
     * Get banks list
     */
    listBanks({ page, perPage }: ListBanksRequest): Observable<BankListBankModel>
    listBanks({ page, perPage }: ListBanksRequest, opts?: OperationOpts): Observable<RawAjaxResponse<BankListBankModel>>
    listBanks({ page, perPage }: ListBanksRequest, opts?: OperationOpts): Observable<BankListBankModel | RawAjaxResponse<BankListBankModel>> {
