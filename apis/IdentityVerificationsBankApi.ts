...
export class IdentityVerificationsBankApi extends BaseAPI {
     ...
     */
    getIdentityVerification({ identityVerificationGuid }: GetIdentityVerificationRequest): Observable<IdentityVerificationWithDetailsBankModel>
    getIdentityVerification({ identityVerificationGuid }: GetIdentityVerificationRequest, opts?: OperationOpts): Observable<AjaxResponse<IdentityVerificationWithDetailsBankModel>>
    getIdentityVerification({ identityVerificationGuid }: GetIdentityVerificationRequest, opts?: OperationOpts): Observable<IdentityVerificationWithDetailsBankModel | AjaxResponse<IdentityVerificationWithDetailsBankModel>> {
     ...
     */
    listIdentityVerifications({ page, perPage, guid, bankGuid, customerGuid, state }: ListIdentityVerificationsRequest): Observable<IdentityVerificationListBankModel>
    listIdentityVerifications({ page, perPage, guid, bankGuid, customerGuid, state }: ListIdentityVerificationsRequest, opts?: OperationOpts): Observable<AjaxResponse<IdentityVerificationListBankModel>>
    listIdentityVerifications({ page, perPage, guid, bankGuid, customerGuid, state }: ListIdentityVerificationsRequest, opts?: OperationOpts): Observable<IdentityVerificationListBankModel | AjaxResponse<IdentityVerificationListBankModel>> {
