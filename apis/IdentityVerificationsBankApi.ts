...
export class IdentityVerificationsBankApi extends BaseAPI {
     ...
     */
    listIdentityVerifications({ page, perPage, guid, bankGuid, customerGuid, state, type }: ListIdentityVerificationsRequest): Observable<IdentityVerificationListBankModel>
    listIdentityVerifications({ page, perPage, guid, bankGuid, customerGuid, state, type }: ListIdentityVerificationsRequest, opts?: OperationOpts): Observable<AjaxResponse<IdentityVerificationListBankModel>>
    listIdentityVerifications({ page, perPage, guid, bankGuid, customerGuid, state, type }: ListIdentityVerificationsRequest, opts?: OperationOpts): Observable<IdentityVerificationListBankModel | AjaxResponse<IdentityVerificationListBankModel>> {
