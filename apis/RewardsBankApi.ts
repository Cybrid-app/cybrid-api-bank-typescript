...
export class RewardsBankApi extends BaseAPI {
     ...
     * Get Reward
     */
    getReward({ rewardGuid }: GetRewardRequest): Observable<RewardBankModel>
    getReward({ rewardGuid }: GetRewardRequest, opts?: OperationOpts): Observable<AjaxResponse<RewardBankModel>>
    getReward({ rewardGuid }: GetRewardRequest, opts?: OperationOpts): Observable<RewardBankModel | AjaxResponse<RewardBankModel>> {
        throwIfNullOrUndefined(rewardGuid, 'rewardGuid', 'getReward');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['rewards:read'])
                    : this.configuration.accessToken }
                : undefined
            ),
        };
        ...
        return this.request<RewardBankModel>({
            url: '/api/rewards/{reward_guid}'.replace('{reward_guid}', encodeURI(rewardGuid)),
            method: 'GET',
            headers,
        }, opts?.responseOpts);
    };
     ...
     * Get rewards list
     */
    listRewards({ page, perPage, guid, bankGuid, customerGuid }: ListRewardsRequest): Observable<RewardListBankModel>
    listRewards({ page, perPage, guid, bankGuid, customerGuid }: ListRewardsRequest, opts?: OperationOpts): Observable<AjaxResponse<RewardListBankModel>>
    listRewards({ page, perPage, guid, bankGuid, customerGuid }: ListRewardsRequest, opts?: OperationOpts): Observable<RewardListBankModel | AjaxResponse<RewardListBankModel>> {
        ...
        return this.request<RewardListBankModel>({
            url: '/api/rewards',
            method: 'GET',
            headers,
            query,
