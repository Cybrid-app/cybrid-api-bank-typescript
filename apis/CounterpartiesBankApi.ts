...
export class CounterpartiesBankApi extends BaseAPI {
     ...
     */
    listCounterparties({ page, perPage, bankGuid, customerGuid, guid, label }: ListCounterpartiesRequest): Observable<CounterpartyListBankModel>
    listCounterparties({ page, perPage, bankGuid, customerGuid, guid, label }: ListCounterpartiesRequest, opts?: OperationOpts): Observable<AjaxResponse<CounterpartyListBankModel>>
    listCounterparties({ page, perPage, bankGuid, customerGuid, guid, label }: ListCounterpartiesRequest, opts?: OperationOpts): Observable<CounterpartyListBankModel | AjaxResponse<CounterpartyListBankModel>> {
