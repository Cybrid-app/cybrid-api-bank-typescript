...
export interface CreateExecutionRequest {
    postExecutionBankModel: PostExecutionBankModel;
}
 ...
 * no description
 */
export class ExecutionsBankApi extends BaseAPI {
     ...
     * Create Execution
     */
    createExecution({ postExecutionBankModel }: CreateExecutionRequest): Observable<ExecutionBankModel>
    createExecution({ postExecutionBankModel }: CreateExecutionRequest, opts?: OperationOpts): Observable<AjaxResponse<ExecutionBankModel>>
    createExecution({ postExecutionBankModel }: CreateExecutionRequest, opts?: OperationOpts): Observable<ExecutionBankModel | AjaxResponse<ExecutionBankModel>> {
        throwIfNullOrUndefined(postExecutionBankModel, 'postExecutionBankModel', 'createExecution');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['executions:execute'])
                    : this.configuration.accessToken }
                : undefined
            ),
        };

        return this.request<ExecutionBankModel>({
            url: '/api/executions',
            method: 'POST',
            headers,
            body: postExecutionBankModel,
        }, opts?.responseOpts);
    };
     ...
     * Get Execution
     */
    getExecution({ executionGuid }: GetExecutionRequest): Observable<ExecutionBankModel>
    getExecution({ executionGuid }: GetExecutionRequest, opts?: OperationOpts): Observable<AjaxResponse<ExecutionBankModel>>
    getExecution({ executionGuid }: GetExecutionRequest, opts?: OperationOpts): Observable<ExecutionBankModel | AjaxResponse<ExecutionBankModel>> {
        throwIfNullOrUndefined(executionGuid, 'executionGuid', 'getExecution');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['executions:read'])
                    : this.configuration.accessToken }
                : undefined
            ),
        };
        ...
        return this.request<ExecutionBankModel>({
            url: '/api/executions/{execution_guid}'.replace('{execution_guid}', encodeURI(executionGuid)),
            method: 'GET',
            headers,
        }, opts?.responseOpts);
    };
     ...
     * Get executions list
     */
    listExecutions({ page, perPage, guid, planGuid, bankGuid, customerGuid, type, state, sourceAccountGuid, destinationAccountGuid, createdAtGte, createdAtLt, updatedAtGte, updatedAtLt }: ListExecutionsRequest): Observable<ExecutionListBankModel>
    listExecutions({ page, perPage, guid, planGuid, bankGuid, customerGuid, type, state, sourceAccountGuid, destinationAccountGuid, createdAtGte, createdAtLt, updatedAtGte, updatedAtLt }: ListExecutionsRequest, opts?: OperationOpts): Observable<AjaxResponse<ExecutionListBankModel>>
    listExecutions({ page, perPage, guid, planGuid, bankGuid, customerGuid, type, state, sourceAccountGuid, destinationAccountGuid, createdAtGte, createdAtLt, updatedAtGte, updatedAtLt }: ListExecutionsRequest, opts?: OperationOpts): Observable<ExecutionListBankModel | AjaxResponse<ExecutionListBankModel>> {
        ...
        if (planGuid != null) { query['plan_guid'] = planGuid; }
        ...
        return this.request<ExecutionListBankModel>({
            url: '/api/executions',
            method: 'GET',
            headers,
            query,
