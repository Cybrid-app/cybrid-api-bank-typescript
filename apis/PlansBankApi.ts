...
export interface CreatePlanRequest {
    postPlanBankModel: PostPlanBankModel;
}
 ...
 * no description
 */
export class PlansBankApi extends BaseAPI {
     ...
     * Create Plan
     */
    createPlan({ postPlanBankModel }: CreatePlanRequest): Observable<PlanBankModel>
    createPlan({ postPlanBankModel }: CreatePlanRequest, opts?: OperationOpts): Observable<AjaxResponse<PlanBankModel>>
    createPlan({ postPlanBankModel }: CreatePlanRequest, opts?: OperationOpts): Observable<PlanBankModel | AjaxResponse<PlanBankModel>> {
        throwIfNullOrUndefined(postPlanBankModel, 'postPlanBankModel', 'createPlan');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['plans:execute'])
                    : this.configuration.accessToken }
                : undefined
            ),
        };

        return this.request<PlanBankModel>({
            url: '/api/plans',
            method: 'POST',
            headers,
            body: postPlanBankModel,
        }, opts?.responseOpts);
    };
     ...
     * Get Plan
     */
    getPlan({ planGuid }: GetPlanRequest): Observable<PlanBankModel>
    getPlan({ planGuid }: GetPlanRequest, opts?: OperationOpts): Observable<AjaxResponse<PlanBankModel>>
    getPlan({ planGuid }: GetPlanRequest, opts?: OperationOpts): Observable<PlanBankModel | AjaxResponse<PlanBankModel>> {
        throwIfNullOrUndefined(planGuid, 'planGuid', 'getPlan');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['plans:read'])
                    : this.configuration.accessToken }
                : undefined
            ),
        };
        ...
        return this.request<PlanBankModel>({
            url: '/api/plans/{plan_guid}'.replace('{plan_guid}', encodeURI(planGuid)),
            method: 'GET',
            headers,
        }, opts?.responseOpts);
    };
     ...
     * Get plans list
     */
    listPlans({ page, perPage, guid, bankGuid, customerGuid, type, state, sourceAccountGuid, destinationAccountGuid, createdAtGte, createdAtLt, updatedAtGte, updatedAtLt, label }: ListPlansRequest): Observable<PlanListBankModel>
    listPlans({ page, perPage, guid, bankGuid, customerGuid, type, state, sourceAccountGuid, destinationAccountGuid, createdAtGte, createdAtLt, updatedAtGte, updatedAtLt, label }: ListPlansRequest, opts?: OperationOpts): Observable<AjaxResponse<PlanListBankModel>>
    listPlans({ page, perPage, guid, bankGuid, customerGuid, type, state, sourceAccountGuid, destinationAccountGuid, createdAtGte, createdAtLt, updatedAtGte, updatedAtLt, label }: ListPlansRequest, opts?: OperationOpts): Observable<PlanListBankModel | AjaxResponse<PlanListBankModel>> {
        ...
        if (sourceAccountGuid != null) { query['source_account_guid'] = sourceAccountGuid; }
        if (destinationAccountGuid != null) { query['destination_account_guid'] = destinationAccountGuid; }
        ...
        return this.request<PlanListBankModel>({
            url: '/api/plans',
            method: 'GET',
            headers,
            query,
