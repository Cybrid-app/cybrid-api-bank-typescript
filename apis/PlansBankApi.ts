...
export class PlansBankApi extends BaseAPI {
     ...
     * Get plans list
     */
    listPlans({ page, perPage, guid, bankGuid, customerGuid, type, state, sourceAccountGuid, destinationAccountGuid, createdAtGte, createdAtLt, updatedAtGte, updatedAtLt }: ListPlansRequest): Observable<PlanListBankModel>
    listPlans({ page, perPage, guid, bankGuid, customerGuid, type, state, sourceAccountGuid, destinationAccountGuid, createdAtGte, createdAtLt, updatedAtGte, updatedAtLt }: ListPlansRequest, opts?: OperationOpts): Observable<AjaxResponse<PlanListBankModel>>
    listPlans({ page, perPage, guid, bankGuid, customerGuid, type, state, sourceAccountGuid, destinationAccountGuid, createdAtGte, createdAtLt, updatedAtGte, updatedAtLt }: ListPlansRequest, opts?: OperationOpts): Observable<PlanListBankModel | AjaxResponse<PlanListBankModel>> {
