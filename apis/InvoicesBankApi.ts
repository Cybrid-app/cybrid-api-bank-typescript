...
export class InvoicesBankApi extends BaseAPI {
     ...
     * List Invoices
     */
    listInvoices({ page, perPage, guid, bankGuid, customerGuid, accountGuid, state, environment, label }: ListInvoicesRequest): Observable<InvoiceListBankModel>
    listInvoices({ page, perPage, guid, bankGuid, customerGuid, accountGuid, state, environment, label }: ListInvoicesRequest, opts?: OperationOpts): Observable<AjaxResponse<InvoiceListBankModel>>
    listInvoices({ page, perPage, guid, bankGuid, customerGuid, accountGuid, state, environment, label }: ListInvoicesRequest, opts?: OperationOpts): Observable<InvoiceListBankModel | AjaxResponse<InvoiceListBankModel>> {
