...
export interface UpdateDepositAddressRequest {
    depositAddressGuid: string;
    patchDepositAddressBankModel: PatchDepositAddressBankModel;
}
...
export class DepositAddressesBankApi extends BaseAPI {
     ...
     */
    updateDepositAddress({ depositAddressGuid, patchDepositAddressBankModel }: UpdateDepositAddressRequest): Observable<DepositAddressBankModel>
    updateDepositAddress({ depositAddressGuid, patchDepositAddressBankModel }: UpdateDepositAddressRequest, opts?: OperationOpts): Observable<AjaxResponse<DepositAddressBankModel>>
    updateDepositAddress({ depositAddressGuid, patchDepositAddressBankModel }: UpdateDepositAddressRequest, opts?: OperationOpts): Observable<DepositAddressBankModel | AjaxResponse<DepositAddressBankModel>> {
        throwIfNullOrUndefined(depositAddressGuid, 'depositAddressGuid', 'updateDepositAddress');
        throwIfNullOrUndefined(patchDepositAddressBankModel, 'patchDepositAddressBankModel', 'updateDepositAddress');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['deposit_addresses:write'])
                    : this.configuration.accessToken }
                : undefined
            ),
        };
        ...
        return this.request<DepositAddressBankModel>({
            ...
            method: 'PATCH',
            headers,
            body: patchDepositAddressBankModel,
        }, opts?.responseOpts);
    };
