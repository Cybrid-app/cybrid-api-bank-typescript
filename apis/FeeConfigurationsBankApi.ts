...
export interface CreateFeeConfigurationRequest {
    postFeeConfigurationBankModel: PostFeeConfigurationBankModel;
}

export interface GetFeeConfigurationRequest {
    feeConfigurationGuid: string;
}

export interface ListFeeConfigurationsRequest {
    page?: number;
    perPage?: number;
}
 ...
 * no description
 */
export class FeeConfigurationsBankApi extends BaseAPI {

    /**
     * Creates a fee configuration.  Required scope: **banks:write**
     * Create Fee Configuration
     */
    createFeeConfiguration({ postFeeConfigurationBankModel }: CreateFeeConfigurationRequest): Observable<FeeConfigurationBankModel>
    createFeeConfiguration({ postFeeConfigurationBankModel }: CreateFeeConfigurationRequest, opts?: OperationOpts): Observable<AjaxResponse<FeeConfigurationBankModel>>
    createFeeConfiguration({ postFeeConfigurationBankModel }: CreateFeeConfigurationRequest, opts?: OperationOpts): Observable<FeeConfigurationBankModel | AjaxResponse<FeeConfigurationBankModel>> {
        throwIfNullOrUndefined(postFeeConfigurationBankModel, 'postFeeConfigurationBankModel', 'createFeeConfiguration');
        ...
        return this.request<FeeConfigurationBankModel>({
            url: '/api/fee_configurations',
            method: 'POST',
            headers,
            body: postFeeConfigurationBankModel,
        }, opts?.responseOpts);
    };
     ...
     */
    getFeeConfiguration({ feeConfigurationGuid }: GetFeeConfigurationRequest): Observable<FeeConfigurationBankModel>
    getFeeConfiguration({ feeConfigurationGuid }: GetFeeConfigurationRequest, opts?: OperationOpts): Observable<AjaxResponse<FeeConfigurationBankModel>>
    getFeeConfiguration({ feeConfigurationGuid }: GetFeeConfigurationRequest, opts?: OperationOpts): Observable<FeeConfigurationBankModel | AjaxResponse<FeeConfigurationBankModel>> {
        throwIfNullOrUndefined(feeConfigurationGuid, 'feeConfigurationGuid', 'getFeeConfiguration');
        ...
        return this.request<FeeConfigurationBankModel>({
            url: '/api/fee_configurations/{fee_configuration_guid}'.replace('{fee_configuration_guid}', encodeURI(feeConfigurationGuid)),
            method: 'GET',
            headers,
        }, opts?.responseOpts);
    };
     ...
     */
    listFeeConfigurations({ page, perPage }: ListFeeConfigurationsRequest): Observable<FeeConfigurationListBankModel>
    listFeeConfigurations({ page, perPage }: ListFeeConfigurationsRequest, opts?: OperationOpts): Observable<AjaxResponse<FeeConfigurationListBankModel>>
    listFeeConfigurations({ page, perPage }: ListFeeConfigurationsRequest, opts?: OperationOpts): Observable<FeeConfigurationListBankModel | AjaxResponse<FeeConfigurationListBankModel>> {
        ...
        return this.request<FeeConfigurationListBankModel>({
            url: '/api/fee_configurations',
            method: 'GET',
            headers,
            query,
