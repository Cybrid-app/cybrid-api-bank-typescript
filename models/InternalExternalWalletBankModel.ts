...
/**
 * @export
 * @interface InternalExternalWalletBankModel
 */
export interface InternalExternalWalletBankModel {
    /**
     * Auto-generated unique identifier for the account.
     * @type {string}
     * @memberof InternalExternalWalletBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalExternalWalletBankModel
     */
    account_kind?: InternalExternalWalletBankModelAccountKindEnum;
    /**
     * The environment that the exchange is operating in.
     * @type {string}
     * @memberof InternalExternalWalletBankModel
     */
    environment?: InternalExternalWalletBankModelEnvironmentEnum;
    /**
     ...
     * @memberof InternalExternalWalletBankModel
     */
    state?: InternalExternalWalletBankModelStateEnum;
    /**
 ...
 * @enum {string}
 */
export enum InternalExternalWalletBankModelAccountKindEnum {
 ...
 * @enum {string}
 */
export enum InternalExternalWalletBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalExternalWalletBankModelStateEnum {
    Storing = 'storing',
    Pending = 'pending',
    Failed = 'failed',
    Completed = 'completed',
