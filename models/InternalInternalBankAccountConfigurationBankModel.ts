...
/**
 * @export
 * @interface InternalInternalBankAccountConfigurationBankModel
 */
export interface InternalInternalBankAccountConfigurationBankModel {
    /**
     * Auto-generated unique identifier for the configuration.
     * @type {string}
     * @memberof InternalInternalBankAccountConfigurationBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalInternalBankAccountConfigurationBankModel
     */
    type?: InternalInternalBankAccountConfigurationBankModelTypeEnum;
    /**
     * The environment the configuration is associated with.
     * @type {string}
     * @memberof InternalInternalBankAccountConfigurationBankModel
     */
    environment?: InternalInternalBankAccountConfigurationBankModelEnvironmentEnum;
    /**
     ...
     * @memberof InternalInternalBankAccountConfigurationBankModel
     */
    invoice_bank_account_guid?: string | null;
    /**
     * The asset code.
     * @type {string}
     * @memberof InternalInternalBankAccountConfigurationBankModel
 ...
 * @enum {string}
 */
export enum InternalInternalBankAccountConfigurationBankModelTypeEnum {
    Platform = 'platform',
    Bank = 'bank'
}
/**
 ...
 * @enum {string}
 */
export enum InternalInternalBankAccountConfigurationBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
