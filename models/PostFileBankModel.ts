...
import type {
    PostFileMetadataBankModel,
} from './';

/**
 * Request body for a new file.
 * @export
 * @interface PostFileBankModel
 */
export interface PostFileBankModel {
    /**
     * The type of file.
     * @type {string}
     * @memberof PostFileBankModel
     */
    type: PostFileBankModelTypeEnum;
    /**
     ...
     * @memberof PostFileBankModel
     */
    content_type: PostFileBankModelContentTypeEnum;
    /**
    ...
    data?: string | null;
    /**
     * @type {PostFileMetadataBankModel}
     * @memberof PostFileBankModel
     */
    metadata?: PostFileMetadataBankModel | null;
}
 ...
 * @enum {string}
 */
export enum PostFileBankModelTypeEnum {
    ...
    IndigenousIdDocument = 'indigenous_id_document',
    Selfie = 'selfie',
    SelfieVideo = 'selfie_video',
    SelfieLeft = 'selfie_left',
    SelfieRight = 'selfie_right',
    ...
    PersonaInquiryReport = 'persona_inquiry_report',
    PersonaInquiryExport = 'persona_inquiry_export'
}
/**
 * @export
 * @enum {string}
 */
export enum PostFileBankModelContentTypeEnum {
