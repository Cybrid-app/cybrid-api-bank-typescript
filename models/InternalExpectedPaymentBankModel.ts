...
/**
 * @export
 * @interface InternalExpectedPaymentBankModel
 */
export interface InternalExpectedPaymentBankModel {
     ...
     * @type {string}
     * @memberof InternalExpectedPaymentBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalExpectedPaymentBankModel
     */
    payment_kind?: InternalExpectedPaymentBankModelPaymentKindEnum;
    /**
     * The environment that the payment is expected in.
     * @type {string}
     * @memberof InternalExpectedPaymentBankModel
     */
    environment?: InternalExpectedPaymentBankModelEnvironmentEnum;
    /**
     ...
     * @memberof InternalExpectedPaymentBankModel
     */
    internal_account_type?: InternalExpectedPaymentBankModelInternalAccountTypeEnum;
    /**
     * The exchange settlement expected payment\'s state
     * @type {string}
     * @memberof InternalExpectedPaymentBankModel
     */
    state?: InternalExpectedPaymentBankModelStateEnum;
    /**
 ...
 * @enum {string}
 */
export enum InternalExpectedPaymentBankModelPaymentKindEnum {
 ...
 * @enum {string}
 */
export enum InternalExpectedPaymentBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalExpectedPaymentBankModelInternalAccountTypeEnum {
 ...
 * @enum {string}
 */
export enum InternalExpectedPaymentBankModelStateEnum {
    Storing = 'storing',
