...
/**
 * @export
 * @interface InternalBankBankModel
 */
export interface InternalBankBankModel {
    /**
     * Auto-generated unique identifier for the bank.
     * @type {string}
     * @memberof InternalBankBankModel
     */
    guid: string;
    /**
     ...
     * @type {Array<BankSupportedPayoutSymbolsInnerBankModel>}
     * @memberof InternalBankBankModel
     */
     ...
     * @memberof InternalBankBankModel
     */
    return_code_thresholds?: { [key: string]: number; };
    /**
