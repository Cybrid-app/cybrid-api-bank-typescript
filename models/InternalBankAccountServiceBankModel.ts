...
/**
 * @export
 * @interface InternalBankAccountServiceBankModel
 */
export interface InternalBankAccountServiceBankModel {
    /**
     * Auto-generated unique identifier for the bank account service.
     * @type {string}
     * @memberof InternalBankAccountServiceBankModel
     */
    guid?: string;
    /**
     * The service type.
     ...
     * @memberof InternalBankAccountServiceBankModel
     */
    type?: InternalBankAccountServiceBankModelTypeEnum;
    /**
    ...
    name?: string;
    /**
     * The environment that the service is operating in.
     * @type {string}
     * @memberof InternalBankAccountServiceBankModel
     */
    environment?: InternalBankAccountServiceBankModelEnvironmentEnum;
    /**
     ...
     * @memberof InternalBankAccountServiceBankModel
     */
    state?: InternalBankAccountServiceBankModelStateEnum;
}
 ...
 * @enum {string}
 */
export enum InternalBankAccountServiceBankModelTypeEnum {
 ...
 * @enum {string}
 */
export enum InternalBankAccountServiceBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalBankAccountServiceBankModelStateEnum {
    Storing = 'storing',
    Created = 'created'
}
