...
/**
 * @export
 * @interface InternalFiatAssetConfigurationBankModel
 */
export interface InternalFiatAssetConfigurationBankModel {
    /**
     * Auto-generated unique identifier for the configuration.
     * @type {string}
     * @memberof InternalFiatAssetConfigurationBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalFiatAssetConfigurationBankModel
     */
    type?: InternalFiatAssetConfigurationBankModelTypeEnum;
    /**
     * The environment the configuration is associated with.
     * @type {string}
     * @memberof InternalFiatAssetConfigurationBankModel
     */
    environment?: InternalFiatAssetConfigurationBankModelEnvironmentEnum;
    /**
     ...
     * @memberof InternalFiatAssetConfigurationBankModel
     */
    maximum_number_of_accounts?: number | null;
    /**
 ...
 * @enum {string}
 */
export enum InternalFiatAssetConfigurationBankModelTypeEnum {
    Platform = 'platform',
    Bank = 'bank'
}
/**
 ...
 * @enum {string}
 */
export enum InternalFiatAssetConfigurationBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
