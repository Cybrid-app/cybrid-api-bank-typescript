...
import type {
    PostInternalExternalBankAccountCounterpartyAddressBankModel,
    PostInternalExternalBankAccountCounterpartyBankAccountBankModel,
    PostInternalExternalBankAccountCounterpartyNameBankModel,
} from './';

/**
 * @export
 * @interface PostInternalExternalBankAccountBankModel
 */
export interface PostInternalExternalBankAccountBankModel {
    /**
     * The name of the account.
     * @type {string}
     * @memberof PostInternalExternalBankAccountBankModel
     */
    name: string;
    /**
     * The account type
     ...
     * @memberof PostInternalExternalBankAccountBankModel
     */
    account_kind: PostInternalExternalBankAccountBankModelAccountKindEnum;
    /**
    ...
    /**
     * @type {PostInternalExternalBankAccountCounterpartyBankAccountBankModel}
     * @memberof PostInternalExternalBankAccountBankModel
     */
    counterparty_bank_account?: PostInternalExternalBankAccountCounterpartyBankAccountBankModel | null;
    /**
     * @type {PostInternalExternalBankAccountCounterpartyNameBankModel}
     * @memberof PostInternalExternalBankAccountBankModel
     */
    counterparty_name?: PostInternalExternalBankAccountCounterpartyNameBankModel | null;
    /**
     * @type {PostInternalExternalBankAccountCounterpartyAddressBankModel}
     * @memberof PostInternalExternalBankAccountBankModel
     */
    counterparty_address?: PostInternalExternalBankAccountCounterpartyAddressBankModel | null;
    /**
     * The counterparty\'s email address on the account (internal).
     * @type {string}
     * @memberof PostInternalExternalBankAccountBankModel
     */
    counterparty_email_address?: string | null;
}
 ...
 * @enum {string}
 */
export enum PostInternalExternalBankAccountBankModelAccountKindEnum {
    ModernTreasuryExternalAccount = 'modern_treasury_external_account',
    Plaid = 'plaid',
