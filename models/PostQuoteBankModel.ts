...
export interface PostQuoteBankModel {
     ...
     * @type {Array<PostFeeBankModel>}
     * @memberof PostQuoteBankModel
     */
    fees?: Array<PostFeeBankModel> | null;
    /**
     ...
     * @memberof PostQuoteBankModel
     */
    payment_rail?: PostQuoteBankModelPaymentRailEnum;
    /**
     ...
     * @type {Array<PostQuoteEntryBankModel>}
     * @memberof PostQuoteBankModel
     */
    destination_accounts?: Array<PostQuoteEntryBankModel>;
    /**
 ...
 * @enum {string}
 */
export enum PostQuoteBankModelProductTypeEnum {
    Trading = 'trading',
    Funding = 'funding',
 ...
 * @enum {string}
 */
export enum PostQuoteBankModelPaymentRailEnum {
    Ach = 'ach',
    Eft = 'eft',
    Wire = 'wire',
    Rtp = 'rtp',
