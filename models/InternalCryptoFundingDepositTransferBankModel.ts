...
/**
 * @export
 * @interface InternalCryptoFundingDepositTransferBankModel
 */
export interface InternalCryptoFundingDepositTransferBankModel {
    /**
     * @type {string}
     * @memberof InternalCryptoFundingDepositTransferBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalCryptoFundingDepositTransferBankModel
     */
    trading_account_customer_guid?: string | null;
    /**
     * @type {string}
     * @memberof InternalCryptoFundingDepositTransferBankModel
     */
