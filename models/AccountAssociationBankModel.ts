...
/**
 * @export
 * @interface AccountAssociationBankModel
 */
export interface AccountAssociationBankModel {
    /**
     * Auto-generated unique identifier for the transfer account.
     * @type {string}
     * @memberof AccountAssociationBankModel
     */
    guid: string;
    /**
     ...
     * @memberof AccountAssociationBankModel
     */
    payment_rail?: AccountAssociationBankModelPaymentRailEnum;
    /**
     * Whether this account was explicitly requested by the caller as an intermediate account.
     * @type {boolean}
     * @memberof AccountAssociationBankModel
     */
    intermediate_requested?: boolean | null;
}
 ...
 * @enum {string}
 */
export enum AccountAssociationBankModelPaymentRailEnum {
    Ach = 'ach',
    Eft = 'eft',
    Wire = 'wire',
    Rtp = 'rtp',
