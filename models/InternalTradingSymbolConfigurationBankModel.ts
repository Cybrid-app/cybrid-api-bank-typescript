...
/**
 * @export
 * @interface InternalTradingSymbolConfigurationBankModel
 */
export interface InternalTradingSymbolConfigurationBankModel {
    /**
     * Auto-generated unique identifier for the configuration.
     * @type {string}
     * @memberof InternalTradingSymbolConfigurationBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalTradingSymbolConfigurationBankModel
     */
    type?: InternalTradingSymbolConfigurationBankModelTypeEnum;
    /**
     * The environment the configuration is associated with.
     * @type {string}
     * @memberof InternalTradingSymbolConfigurationBankModel
     */
    environment?: InternalTradingSymbolConfigurationBankModelEnvironmentEnum;
    /**
     ...
     * @memberof InternalTradingSymbolConfigurationBankModel
     */
    execution_mode?: InternalTradingSymbolConfigurationBankModelExecutionModeEnum;
    /**
 ...
 * @enum {string}
 */
export enum InternalTradingSymbolConfigurationBankModelTypeEnum {
    Platform = 'platform',
    Bank = 'bank'
}
/**
 ...
 * @enum {string}
 */
export enum InternalTradingSymbolConfigurationBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalTradingSymbolConfigurationBankModelExecutionModeEnum {
    Binding = 'binding',
    NonBinding = 'non_binding'
}
