...
export interface QuoteBankModel {
     ...
     * @memberof QuoteBankModel
     */
    product_type?: QuoteBankModelProductTypeEnum;
    /**
     ...
     * @memberof QuoteBankModel
     */
    product_provider?: QuoteBankModelProductProviderEnum;
}
 ...
 * @enum {string}
 */
export enum QuoteBankModelProductTypeEnum {
    Trading = 'trading',
    Savings = 'savings'
}
/**
 ...
 * @enum {string}
 */
export enum QuoteBankModelSideEnum {
    Buy = 'buy',
    Sell = 'sell',
    Deposit = 'deposit',
 ...
 * @enum {string}
 */
export enum QuoteBankModelProductProviderEnum {
    Compound = 'compound'
}
