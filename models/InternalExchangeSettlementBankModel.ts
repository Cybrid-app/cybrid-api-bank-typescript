...
import type {
    InternalExchangeSettlementOrderAmountsInnerBankModel,
    InternalExchangeSettlementTradeAmountsInnerBankModel,
} from './';

/**
 * @export
 * @interface InternalExchangeSettlementBankModel
 */
export interface InternalExchangeSettlementBankModel {
    /**
     * Auto-generated unique identifier for the exchange settlement.
     * @type {string}
     * @memberof InternalExchangeSettlementBankModel
     */
    guid: string;
    /**
     ...
     * @memberof InternalExchangeSettlementBankModel
     */
    environment: InternalExchangeSettlementBankModelEnvironmentEnum;
    /**
     ...
     * @type {Array<InternalExchangeSettlementTradeAmountsInnerBankModel>}
     * @memberof InternalExchangeSettlementBankModel
     */
     ...
     * @type {Array<InternalExchangeSettlementOrderAmountsInnerBankModel>}
     * @memberof InternalExchangeSettlementBankModel
     */
     ...
     * @memberof InternalExchangeSettlementBankModel
     */
    state: InternalExchangeSettlementBankModelStateEnum;
    /**
 ...
 * @enum {string}
 */
export enum InternalExchangeSettlementBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalExchangeSettlementBankModelStateEnum {
    Storing = 'storing',
