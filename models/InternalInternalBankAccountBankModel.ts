...
/**
 * @export
 * @interface InternalInternalBankAccountBankModel
 */
export interface InternalInternalBankAccountBankModel {
    /**
     * Auto-generated unique identifier for the account.
     * @type {string}
     * @memberof InternalInternalBankAccountBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalInternalBankAccountBankModel
     */
    account_kind?: InternalInternalBankAccountBankModelAccountKindEnum;
    /**
     * The environment that the exchange is operating in.
     * @type {string}
     * @memberof InternalInternalBankAccountBankModel
     */
    environment?: InternalInternalBankAccountBankModelEnvironmentEnum;
    /**
     ...
     * @memberof InternalInternalBankAccountBankModel
     */
    state?: InternalInternalBankAccountBankModelStateEnum;
    /**
 ...
 * @enum {string}
 */
export enum InternalInternalBankAccountBankModelAccountKindEnum {
    CircleMasterWallet = 'circle_master_wallet',
    ModernTreasuryInternalAccount = 'modern_treasury_internal_account',
 ...
 * @enum {string}
 */
export enum InternalInternalBankAccountBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalInternalBankAccountBankModelStateEnum {
    Storing = 'storing',
    Created = 'created'
}
