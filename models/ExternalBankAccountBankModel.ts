...
export interface ExternalBankAccountBankModel {
     ...
     * @memberof ExternalBankAccountBankModel
     */
    state?: ExternalBankAccountBankModelStateEnum;
    /**
    ...
    /**
     * @type {ExternalBankAccountBalancesBankModel}
     * @memberof ExternalBankAccountBankModel
     */
    balances?: ExternalBankAccountBalancesBankModel | null;
    /**
     * The account holder information.
     * @type {Array<ExternalBankAccountPiiInnerBankModel>}
     * @memberof ExternalBankAccountBankModel
     */
    pii?: Array<ExternalBankAccountPiiInnerBankModel> | null;
}
 ...
 * @enum {string}
 */
export enum ExternalBankAccountBankModelStateEnum {
    Storing = 'storing',
    Completed = 'completed',
    Failed = 'failed',
