...
import type {
    InternalTransferAssociationBankModel,
} from './';

/**
 * @export
 * @interface PostInternalTransferBankModel
 */
export interface PostInternalTransferBankModel {
    /**
     * The type of internal transfer.
     * @type {string}
     * @memberof PostInternalTransferBankModel
     */
    transfer_type: PostInternalTransferBankModelTransferTypeEnum;
    /**
     * The environment to transfer funds in.
     * @type {string}
     * @memberof PostInternalTransferBankModel
     */
    environment: PostInternalTransferBankModelEnvironmentEnum;
    /**
     * The associated quote\'s identifier.
     * @type {string}
     * @memberof PostInternalTransferBankModel
     */
    quote_guid?: string | null;
    /**
     ...
     * @memberof PostInternalTransferBankModel
     */
    supports_reconciliation?: boolean | null;
    /**
     ...
     * @type {Array<InternalTransferAssociationBankModel>}
     * @memberof PostInternalTransferBankModel
     */
 ...
 * @enum {string}
 */
export enum PostInternalTransferBankModelTransferTypeEnum {
    Book = 'book',
 ...
 * @enum {string}
 */
export enum PostInternalTransferBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
