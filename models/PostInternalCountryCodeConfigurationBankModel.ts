...
/**
 * @export
 * @interface PostInternalCountryCodeConfigurationBankModel
 */
export interface PostInternalCountryCodeConfigurationBankModel {
    /**
     * The type of country code configuration: bank or platform.
     * @type {string}
     * @memberof PostInternalCountryCodeConfigurationBankModel
     */
    type: PostInternalCountryCodeConfigurationBankModelTypeEnum;
    /**
     * The environment the configuration is associated with.
     * @type {string}
     * @memberof PostInternalCountryCodeConfigurationBankModel
     */
    environment?: PostInternalCountryCodeConfigurationBankModelEnvironmentEnum;
    /**
 ...
 * @enum {string}
 */
export enum PostInternalCountryCodeConfigurationBankModelTypeEnum {
    Platform = 'platform',
    Bank = 'bank'
}
/**
 ...
 * @enum {string}
 */
export enum PostInternalCountryCodeConfigurationBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
