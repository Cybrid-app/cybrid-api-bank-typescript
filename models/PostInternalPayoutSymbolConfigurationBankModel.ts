...
/**
 * @export
 * @interface PostInternalPayoutSymbolConfigurationBankModel
 */
export interface PostInternalPayoutSymbolConfigurationBankModel {
    /**
     * The payout symbol configuration type.
     * @type {string}
     * @memberof PostInternalPayoutSymbolConfigurationBankModel
     */
    type: PostInternalPayoutSymbolConfigurationBankModelTypeEnum;
    /**
     * The environment the configuration is associated with.
     * @type {string}
     * @memberof PostInternalPayoutSymbolConfigurationBankModel
     */
    environment?: PostInternalPayoutSymbolConfigurationBankModelEnvironmentEnum;
    /**
     ...
     * @memberof PostInternalPayoutSymbolConfigurationBankModel
     */
    participants_type: PostInternalPayoutSymbolConfigurationBankModelParticipantsTypeEnum;
    /**
     * The route the symbol is enabled for.
     * @type {string}
     * @memberof PostInternalPayoutSymbolConfigurationBankModel
     */
    route: PostInternalPayoutSymbolConfigurationBankModelRouteEnum;
}
 ...
 * @enum {string}
 */
export enum PostInternalPayoutSymbolConfigurationBankModelTypeEnum {
    Platform = 'platform',
    Bank = 'bank'
}
/**
 ...
 * @enum {string}
 */
export enum PostInternalPayoutSymbolConfigurationBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum PostInternalPayoutSymbolConfigurationBankModelParticipantsTypeEnum {
    C2C = 'C2C',
    C2B = 'C2B',
    B2C = 'B2C',
    B2B = 'B2B'
 ...
 * @enum {string}
 */
export enum PostInternalPayoutSymbolConfigurationBankModelRouteEnum {
