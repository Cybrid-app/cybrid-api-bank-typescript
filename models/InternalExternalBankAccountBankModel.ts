...
import type {
    ...
    InternalExternalBankAccountPiiInnerBankModel,
} from './';

/**
 * @export
 * @interface InternalExternalBankAccountBankModel
 */
export interface InternalExternalBankAccountBankModel {
    /**
     * Auto-generated unique identifier for the account.
     * @type {string}
     * @memberof InternalExternalBankAccountBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalExternalBankAccountBankModel
     */
    account_kind?: InternalExternalBankAccountBankModelAccountKindEnum;
    /**
     * The environment that the external bank account is operating in.
     * @type {string}
     * @memberof InternalExternalBankAccountBankModel
     */
    environment?: InternalExternalBankAccountBankModelEnvironmentEnum;
    /**
     * The bank identifier.
     * @type {string}
     * @memberof InternalExternalBankAccountBankModel
     ...
     * @memberof InternalExternalBankAccountBankModel
     */
    state?: InternalExternalBankAccountBankModelStateEnum;
    /**
     ...
     * @type {Array<InternalExternalBankAccountPiiInnerBankModel>}
     * @memberof InternalExternalBankAccountBankModel
     */
 ...
 * @enum {string}
 */
export enum InternalExternalBankAccountBankModelAccountKindEnum {
 ...
 * @enum {string}
 */
export enum InternalExternalBankAccountBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalExternalBankAccountBankModelStateEnum {
    Storing = 'storing',
    Completed = 'completed',
    Failed = 'failed',
