...
/**
 * @export
 * @interface InternalCryptoAssetConfigurationBankModel
 */
export interface InternalCryptoAssetConfigurationBankModel {
    /**
     * Auto-generated unique identifier for the configuration.
     * @type {string}
     * @memberof InternalCryptoAssetConfigurationBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalCryptoAssetConfigurationBankModel
     */
    type?: InternalCryptoAssetConfigurationBankModelTypeEnum;
    /**
     * The environment the configuration is associated with.
     * @type {string}
     * @memberof InternalCryptoAssetConfigurationBankModel
     */
    environment?: InternalCryptoAssetConfigurationBankModelEnvironmentEnum;
    /**
    ...
    /**
     * The maximum number of deposit addresses allowed for the asset on the platform.
     * @type {number}
     * @memberof InternalCryptoAssetConfigurationBankModel
     */
    maximum_number_of_addresses?: number | null;
    /**
     * The asset code.
     * @type {string}
     * @memberof InternalCryptoAssetConfigurationBankModel
 ...
 * @enum {string}
 */
export enum InternalCryptoAssetConfigurationBankModelTypeEnum {
    Platform = 'platform',
    Bank = 'bank'
}
/**
 ...
 * @enum {string}
 */
export enum InternalCryptoAssetConfigurationBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
