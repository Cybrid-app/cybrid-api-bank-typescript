...
/**
 * @export
 * @interface InternalPostQuoteBankModel
 */
export interface InternalPostQuoteBankModel {
    /**
     * The type of product the quote is for.
     * @type {string}
     * @memberof InternalPostQuoteBankModel
     */
    product_type: InternalPostQuoteBankModelProductTypeEnum;
    /**
     ...
     * @memberof InternalPostQuoteBankModel
     */
    side?: InternalPostQuoteBankModelSideEnum;
    /**
     ...
     * @memberof InternalPostQuoteBankModel
     */
    environment?: InternalPostQuoteBankModelEnvironmentEnum;
    /**
 ...
 * @enum {string}
 */
export enum InternalPostQuoteBankModelProductTypeEnum {
    BookTransfer = 'book_transfer',
    TradingLiquidation = 'trading_liquidation',
    InternalTrading = 'internal_trading',
    InternalBankRebalance = 'internal_bank_rebalance',
    InternalWalletRebalance = 'internal_wallet_rebalance',
    LossRecoveryTransfer = 'loss_recovery_transfer'
}
/**
 * @export
 * @enum {string}
 */
export enum InternalPostQuoteBankModelSideEnum {
    Buy = 'buy',
    Sell = 'sell',
    Deposit = 'deposit',
 ...
 * @enum {string}
 */
export enum InternalPostQuoteBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
