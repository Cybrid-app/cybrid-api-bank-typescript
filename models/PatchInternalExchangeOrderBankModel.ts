 ...
 * @export
 * @interface PatchInternalExchangeOrderBankModel
 */
export interface PatchInternalExchangeOrderBankModel {
    /**
     * The unique identifier for the order in the provider system.
     * @type {string}
     * @memberof PatchInternalExchangeOrderBankModel
     */
    provider_order_guid?: string | null;
    /**
     ...
     * @memberof PatchInternalExchangeOrderBankModel
     */
    state?: PatchInternalExchangeOrderBankModelStateEnum;
    /**
     ...
     * @memberof PatchInternalExchangeOrderBankModel
     */
    failure_code?: PatchInternalExchangeOrderBankModelFailureCodeEnum;
}
 ...
 * @enum {string}
 */
export enum PatchInternalExchangeOrderBankModelStateEnum {
    Storing = 'storing',
    Pending = 'pending',
    Completed = 'completed',
    Failed = 'failed'
 ...
 * @enum {string}
 */
export enum PatchInternalExchangeOrderBankModelFailureCodeEnum {
