...
export interface FeeConfigurationBankModel {
     ...
     * @memberof FeeConfigurationBankModel
     */
    product_type?: FeeConfigurationBankModelProductTypeEnum;
    /**
     * The asset code.
     * @type {string}
     * @memberof FeeConfigurationBankModel
     ...
     * @memberof FeeConfigurationBankModel
     */
    product_provider?: FeeConfigurationBankModelProductProviderEnum;
    /**
 ...
 * @enum {string}
 */
export enum FeeConfigurationBankModelProductTypeEnum {
    Trading = 'trading',
    Savings = 'savings'
}
/**
 ...
 * @enum {string}
 */
export enum FeeConfigurationBankModelProductProviderEnum {
    Compound = 'compound'
}
