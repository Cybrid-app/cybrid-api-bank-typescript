...
/**
 * @export
 * @interface PatchInternalTransferBankModel
 */
export interface PatchInternalTransferBankModel {
    /**
     * The state of the transfer.
     * @type {string}
     * @memberof PatchInternalTransferBankModel
     */
    state?: PatchInternalTransferBankModelStateEnum;
    /**
     ...
     * @memberof PatchInternalTransferBankModel
     */
    network_fee_liability_amount?: number;
    /**
 ...
 * @enum {string}
 */
export enum PatchInternalTransferBankModelStateEnum {
    Pending = 'pending',
    Holding = 'holding',
    Reviewing = 'reviewing',
    Completed = 'completed',
