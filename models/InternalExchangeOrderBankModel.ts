 ...
 * @export
 * @interface InternalExchangeOrderBankModel
 */
export interface InternalExchangeOrderBankModel {
    /**
     * The platform environment.
     * @type {string}
     * @memberof InternalExchangeOrderBankModel
     */
    environment: InternalExchangeOrderBankModelEnvironmentEnum;
    /**
     ...
     * @memberof InternalExchangeOrderBankModel
     */
    type: InternalExchangeOrderBankModelTypeEnum;
    /**
     ...
     * @memberof InternalExchangeOrderBankModel
     */
    side: InternalExchangeOrderBankModelSideEnum;
    /**
     ...
     * @memberof InternalExchangeOrderBankModel
     */
    requested_deliver_amount: number;
    /**
     ...
     * @memberof InternalExchangeOrderBankModel
     */
    executed_deliver_amount?: number | null;
    /**
     * The executed receive amount in cents.
     * @type {number}
     * @memberof InternalExchangeOrderBankModel
     */
    executed_receive_amount?: number | null;
    /**
     * The unassigned deliver amount in cents.
     * @type {number}
     * @memberof InternalExchangeOrderBankModel
     */
    unassigned_deliver_amount?: number | null;
    /**
     * The unassigned receive amount in cents.
     * @type {number}
     * @memberof InternalExchangeOrderBankModel
     */
    unassigned_receive_amount?: number | null;
    /**
     ...
     * @memberof InternalExchangeOrderBankModel
     */
    state: InternalExchangeOrderBankModelStateEnum;
    /**
     * The failure code if the entity is in a failed state.
     * @type {string}
     * @memberof InternalExchangeOrderBankModel
     */
    failure_code?: InternalExchangeOrderBankModelFailureCodeEnum;
}
 ...
 * @enum {string}
 */
export enum InternalExchangeOrderBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalExchangeOrderBankModelTypeEnum {
    Fixed = 'fixed'
}
/**
 * @export
 * @enum {string}
 */
export enum InternalExchangeOrderBankModelSideEnum {
    Buy = 'buy',
    Sell = 'sell'
}
/**
 ...
 * @enum {string}
 */
export enum InternalExchangeOrderBankModelStateEnum {
    Storing = 'storing',
    Pending = 'pending',
    Completed = 'completed',
    Failed = 'failed'
 ...
 * @enum {string}
 */
export enum InternalExchangeOrderBankModelFailureCodeEnum {
