 ...
 * @export
 * @interface PostCustomerBankModel
 */
export interface PostCustomerBankModel {
    /**
     * The type of customer.
     * @type {string}
     * @memberof PostCustomerBankModel
     */
    type: PostCustomerBankModelTypeEnum;
    /**
     * @type {PostCustomerAddressBankModel}
     * @memberof PostCustomerBankModel
     */
    ...
    /**
     * @type {PostCustomerNameBankModel}
     * @memberof PostCustomerBankModel
     */
     ...
     * @type {Array<PostCustomerAliasesInnerBankModel>}
     * @memberof PostCustomerBankModel
     */
    aliases?: Array<PostCustomerAliasesInnerBankModel> | null;
    /**
 ...
 * @enum {string}
 */
export enum PostCustomerBankModelTypeEnum {
    Business = 'business',
