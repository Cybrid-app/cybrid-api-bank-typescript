...
import type {
    PostInternalInternalWalletRoutingDetailBankModel,
} from './';

/**
 * @export
 * @interface PostInternalInternalWalletBankModel
 */
export interface PostInternalInternalWalletBankModel {
    /**
     * The type of internal wallet.
     * @type {string}
     * @memberof PostInternalInternalWalletBankModel
     */
    type: PostInternalInternalWalletBankModelTypeEnum;
    /**
     ...
     * @memberof PostInternalInternalWalletBankModel
     */
    account_kind: PostInternalInternalWalletBankModelAccountKindEnum;
    /**
     * The account environment.
     * @type {string}
     * @memberof PostInternalInternalWalletBankModel
     */
    environment: PostInternalInternalWalletBankModelEnvironmentEnum;
    /**
     ...
     * @type {Array<PostInternalInternalWalletRoutingDetailBankModel>}
     * @memberof PostInternalInternalWalletBankModel
     */
    routing_details?: Array<PostInternalInternalWalletRoutingDetailBankModel> | null;
}
 ...
 * @enum {string}
 */
export enum PostInternalInternalWalletBankModelTypeEnum {
 ...
 * @enum {string}
 */
export enum PostInternalInternalWalletBankModelAccountKindEnum {
 ...
 * @enum {string}
 */
export enum PostInternalInternalWalletBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
