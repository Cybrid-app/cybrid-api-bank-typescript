...
/**
 * @export
 * @interface PostTradeBankModel
 */
export interface PostTradeBankModel {
    /**
     * The associated quote\'s identifier.
     * @type {string}
     * @memberof PostTradeBankModel
     */
    quote_guid: string;
    /**
     ...
     * @memberof PostTradeBankModel
     */
    expected_error?: PostTradeBankModelExpectedErrorEnum;
}
 ...
 * @enum {string}
 */
export enum PostTradeBankModelExpectedErrorEnum {
    UnexpectedError = 'unexpected_error',
    InvalidQuoteGuid = 'invalid_quote_guid',
