...
/**
 * @export
 * @interface InternalTradeBankModel
 */
export interface InternalTradeBankModel {
    /**
     * Auto-generated unique identifier for the trade.
     * @type {string}
     * @memberof InternalTradeBankModel
     */
    guid?: string;
    /**
     * The type of trade.
     ...
     * @memberof InternalTradeBankModel
     */
    trade_type?: InternalTradeBankModelTradeTypeEnum;
    /**
     ...
     * @memberof InternalTradeBankModel
     */
    side?: InternalTradeBankModelSideEnum;
    /**
     * The trade\'s state
     * @type {string}
     * @memberof InternalTradeBankModel
     */
    state?: InternalTradeBankModelStateEnum;
    /**
 ...
 * @enum {string}
 */
export enum InternalTradeBankModelTradeTypeEnum {
    Platform = 'platform',
    Internal = 'internal',
 ...
 * @enum {string}
 */
export enum InternalTradeBankModelSideEnum {
    Buy = 'buy',
    Sell = 'sell'
}
/**
 ...
 * @enum {string}
 */
export enum InternalTradeBankModelStateEnum {
    Storing = 'storing',
    Pending = 'pending',
    Cancelled = 'cancelled',
    Completed = 'completed',
