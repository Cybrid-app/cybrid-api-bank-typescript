...
export interface BankBankModel {
     ...
     * @memberof BankBankModel
     */
    features: Array<BankBankModelFeaturesEnum>;
    /**
     * Configuration for supporting creating routable bank accounts.
     * @type {string}
     * @memberof BankBankModel
     */
    routable_accounts?: BankBankModelRoutableAccountsEnum;
    /**
 ...
 * @enum {string}
 */
export enum BankBankModelTypeEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum BankBankModelFeaturesEnum {
 ...
 * @enum {string}
 */
export enum BankBankModelRoutableAccountsEnum {
