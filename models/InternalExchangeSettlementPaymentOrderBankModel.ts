...
/**
 * @export
 * @interface InternalExchangeSettlementPaymentOrderBankModel
 */
export interface InternalExchangeSettlementPaymentOrderBankModel {
    /**
     * Auto-generated unique identifier for the exchange settlement payment order.
     * @type {string}
     * @memberof InternalExchangeSettlementPaymentOrderBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalExchangeSettlementPaymentOrderBankModel
     */
    internal_account_type?: InternalExchangeSettlementPaymentOrderBankModelInternalAccountTypeEnum;
    /**
     ...
     * @memberof InternalExchangeSettlementPaymentOrderBankModel
     */
    external_account_type?: InternalExchangeSettlementPaymentOrderBankModelExternalAccountTypeEnum;
    /**
     * The exchange settlement payment order\'s state
     * @type {string}
     * @memberof InternalExchangeSettlementPaymentOrderBankModel
     */
    state?: InternalExchangeSettlementPaymentOrderBankModelStateEnum;
    /**
 ...
 * @enum {string}
 */
export enum InternalExchangeSettlementPaymentOrderBankModelInternalAccountTypeEnum {
 ...
 * @enum {string}
 */
export enum InternalExchangeSettlementPaymentOrderBankModelExternalAccountTypeEnum {
 ...
 * @enum {string}
 */
export enum InternalExchangeSettlementPaymentOrderBankModelStateEnum {
    Storing = 'storing',
