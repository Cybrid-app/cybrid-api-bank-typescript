...
export interface ExchangeBankModel {
     ...
     * @memberof ExchangeBankModel
     */
    provider?: ExchangeBankModelProviderEnum;
    /**
     * The environment that the exchange is operating in.
     * @type {string}
     * @memberof ExchangeBankModel
     */
    environment?: ExchangeBankModelEnvironmentEnum;
    /**
 ...
 * @enum {string}
 */
export enum ExchangeBankModelProviderEnum {
    Aquanow = 'aquanow',
    DvChain = 'dv_chain'
}
/**
 ...
 * @enum {string}
 */
export enum ExchangeBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
