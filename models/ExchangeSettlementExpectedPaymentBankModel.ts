...
/**
 * @export
 * @interface ExchangeSettlementExpectedPaymentBankModel
 */
export interface ExchangeSettlementExpectedPaymentBankModel {
     ...
     * @type {string}
     * @memberof ExchangeSettlementExpectedPaymentBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof ExchangeSettlementExpectedPaymentBankModel
     */
    internal_account_type?: ExchangeSettlementExpectedPaymentBankModelInternalAccountTypeEnum;
    /**
     * The exchange settlement expected payment\'s state
     * @type {string}
     * @memberof ExchangeSettlementExpectedPaymentBankModel
     */
    state?: ExchangeSettlementExpectedPaymentBankModelStateEnum;
    /**
 ...
 * @enum {string}
 */
export enum ExchangeSettlementExpectedPaymentBankModelInternalAccountTypeEnum {
 ...
 * @enum {string}
 */
export enum ExchangeSettlementExpectedPaymentBankModelStateEnum {
    Storing = 'storing',
