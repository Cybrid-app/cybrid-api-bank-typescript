...
/**
 * @export
 * @interface InternalInternalWalletBankModel
 */
export interface InternalInternalWalletBankModel {
    /**
     * Auto-generated unique identifier for the account.
     * @type {string}
     * @memberof InternalInternalWalletBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalInternalWalletBankModel
     */
    type?: InternalInternalWalletBankModelTypeEnum;
    /**
     ...
     * @memberof InternalInternalWalletBankModel
     */
    account_kind?: InternalInternalWalletBankModelAccountKindEnum;
    /**
     * The environment that the exchange is operating in.
     * @type {string}
     * @memberof InternalInternalWalletBankModel
     */
    environment?: InternalInternalWalletBankModelEnvironmentEnum;
    /**
     ...
     * @memberof InternalInternalWalletBankModel
     */
    state?: InternalInternalWalletBankModelStateEnum;
    /**
 ...
 * @enum {string}
 */
export enum InternalInternalWalletBankModelTypeEnum {
    Omnibus = 'internal_omnibus',
    TradingDeposits = 'internal_trading_deposits'
}
/**
 * @export
 * @enum {string}
 */
export enum InternalInternalWalletBankModelAccountKindEnum {
    FireblocksVault = 'fireblocks_vault',
    CircleMasterWallet = 'circle_master_wallet',
    StrikeAccount = 'strike_account',
    BitgoEnterpriseWallet = 'bitgo_enterprise_wallet',
    FalconxAccount = 'falconx_account',
    AquanowAccount = 'aquanow_account',
    BitsoAccount = 'bitso_account'
}
/**
 * @export
 * @enum {string}
 */
export enum InternalInternalWalletBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalInternalWalletBankModelStateEnum {
    Storing = 'storing',
    Created = 'created'
}
