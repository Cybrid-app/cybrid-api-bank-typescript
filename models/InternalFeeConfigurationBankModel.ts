...
/**
 * @export
 * @interface InternalFeeConfigurationBankModel
 */
export interface InternalFeeConfigurationBankModel {
    /**
     * Auto-generated unique identifier for the configuration.
     * @type {string}
     * @memberof InternalFeeConfigurationBankModel
     */
    guid?: string;
    /**
     * The bank identifier.
     ...
     * @memberof InternalFeeConfigurationBankModel
     */
    type?: InternalFeeConfigurationBankModelTypeEnum;
    /**
     * The type of product being configured.
     * @type {string}
     * @memberof InternalFeeConfigurationBankModel
     */
    product_type?: InternalFeeConfigurationBankModelProductTypeEnum;
    /**
     * The asset code.
     * @type {string}
     * @memberof InternalFeeConfigurationBankModel
     ...
     * @type {Array<InternalFeeBankModel>}
     * @memberof InternalFeeConfigurationBankModel
     */
 ...
 * @enum {string}
 */
export enum InternalFeeConfigurationBankModelTypeEnum {
    Platform = 'platform',
    Bank = 'bank'
}
/**
 ...
 * @enum {string}
 */
export enum InternalFeeConfigurationBankModelProductTypeEnum {
    Trading = 'trading',
    Funding = 'funding',
