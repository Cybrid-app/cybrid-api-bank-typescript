...
/**
 * @export
 * @interface InternalCybridAccountBankModel
 */
export interface InternalCybridAccountBankModel {
    /**
     * The account type.
     * @type {string}
     * @memberof InternalCybridAccountBankModel
     */
    type?: InternalCybridAccountBankModelTypeEnum;
    /**
     ...
     * @memberof InternalCybridAccountBankModel
     */
    environment?: InternalCybridAccountBankModelEnvironmentEnum;
    /**
     * The state of the account.
     * @type {string}
     * @memberof InternalCybridAccountBankModel
     */
    state?: InternalCybridAccountBankModelStateEnum;
}
 ...
 * @enum {string}
 */
export enum InternalCybridAccountBankModelTypeEnum {
    Fee = 'fee',
    Gas = 'gas',
    Position = 'position'
}
 ...
 * @enum {string}
 */
export enum InternalCybridAccountBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalCybridAccountBankModelStateEnum {
    Storing = 'storing',
    Created = 'created'
}
