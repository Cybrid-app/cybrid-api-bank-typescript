...
export interface InternalQuoteBankModel {
     ...
     * @memberof InternalQuoteBankModel
     */
    product_type?: InternalQuoteBankModelProductTypeEnum;
    /**
     ...
     * @memberof InternalQuoteBankModel
     */
    side?: InternalQuoteBankModelSideEnum;
    /**
 ...
 * @enum {string}
 */
export enum InternalQuoteBankModelProductTypeEnum {
    Trading = 'trading',
 ...
 * @enum {string}
 */
export enum InternalQuoteBankModelSideEnum {
    Buy = 'buy',
    Sell = 'sell',
    Deposit = 'deposit',
