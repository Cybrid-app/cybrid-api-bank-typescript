...
export interface InternalComplianceDecisionBankModel {
     ...
     * @memberof InternalComplianceDecisionBankModel
     */
    type?: InternalComplianceDecisionBankModelTypeEnum;
    /**
     ...
     * @memberof InternalComplianceDecisionBankModel
     */
    state?: InternalComplianceDecisionBankModelStateEnum;
    /**
     * The outcome of the verification process.
     * @type {string}
     * @memberof InternalComplianceDecisionBankModel
     */
    outcome?: InternalComplianceDecisionBankModelOutcomeEnum;
    /**
     * The reason codes explaining the outcome.
     * @type {Array<string>}
     * @memberof InternalComplianceDecisionBankModel
     */
    failure_codes?: Array<InternalComplianceDecisionBankModelFailureCodesEnum>;
}
 ...
 * @enum {string}
 */
export enum InternalComplianceDecisionBankModelTypeEnum {
 ...
 * @enum {string}
 */
export enum InternalComplianceDecisionBankModelStateEnum {
    Decided = 'decided',
    Expired = 'expired',
 ...
 * @enum {string}
 */
export enum InternalComplianceDecisionBankModelOutcomeEnum {
    Passed = 'passed',
    Failed = 'failed'
}
/**
 ...
 * @enum {string}
 */
export enum InternalComplianceDecisionBankModelFailureCodesEnum {
