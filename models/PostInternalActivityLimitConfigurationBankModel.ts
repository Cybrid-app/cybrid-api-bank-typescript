...
import type {
    ParamInternalActivityLimitBankModel,
} from './';

/**
 * Request body for activity limit configuration creation.
 * @export
 * @interface PostInternalActivityLimitConfigurationBankModel
 */
export interface PostInternalActivityLimitConfigurationBankModel {
    /**
     * The type of the configuration.
     * @type {string}
     * @memberof PostInternalActivityLimitConfigurationBankModel
     */
    type: PostInternalActivityLimitConfigurationBankModelTypeEnum;
    /**
     * The activity type of the configuration.
     * @type {string}
     * @memberof PostInternalActivityLimitConfigurationBankModel
     */
    activity?: PostInternalActivityLimitConfigurationBankModelActivityEnum;
    /**
     * The side of the activity.
     * @type {string}
     * @memberof PostInternalActivityLimitConfigurationBankModel
     */
    side?: PostInternalActivityLimitConfigurationBankModelSideEnum;
    /**
     * The limits for the configuration.
     * @type {Array<ParamInternalActivityLimitBankModel>}
     * @memberof PostInternalActivityLimitConfigurationBankModel
     */
     ...
     * @memberof PostInternalActivityLimitConfigurationBankModel
     */
    environment?: PostInternalActivityLimitConfigurationBankModelEnvironmentEnum;
    /**
     * The audience for the configuration. Required when type is platform or type is bank.
     * @type {string}
     * @memberof PostInternalActivityLimitConfigurationBankModel
     */
    audience?: PostInternalActivityLimitConfigurationBankModelAudienceEnum;
    /**
 ...
 * @enum {string}
 */
export enum PostInternalActivityLimitConfigurationBankModelTypeEnum {
    Platform = 'platform',
    Bank = 'bank',
    Customer = 'customer'
}
 ...
 * @enum {string}
 */
export enum PostInternalActivityLimitConfigurationBankModelActivityEnum {
    Trading = 'trading',
    Funding = 'funding',
 ...
 * @enum {string}
 */
export enum PostInternalActivityLimitConfigurationBankModelSideEnum {
    Deposit = 'deposit',
 ...
 * @enum {string}
 */
export enum PostInternalActivityLimitConfigurationBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum PostInternalActivityLimitConfigurationBankModelAudienceEnum {
