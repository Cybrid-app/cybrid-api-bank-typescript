...
/**
 * @export
 * @interface PostAccountBankModel
 */
export interface PostAccountBankModel {
    /**
     * The account type.
     * @type {string}
     * @memberof PostAccountBankModel
     */
    type: PostAccountBankModelTypeEnum;
    /**
     * The account provider, if applicable.
     * @type {string}
     * @memberof PostAccountBankModel
     */
    provider?: PostAccountBankModelProviderEnum;
    /**
 ...
 * @enum {string}
 */
export enum PostAccountBankModelTypeEnum {
    Staking = 'staking',
    Trading = 'trading',
    Savings = 'savings'
}
 ...
 * @enum {string}
 */
export enum PostAccountBankModelProviderEnum {
    Compound = 'compound'
}
