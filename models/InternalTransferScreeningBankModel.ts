...
/**
 * @export
 * @interface InternalTransferScreeningBankModel
 */
export interface InternalTransferScreeningBankModel {
    /**
     * The identifier of the transfer screening.
     * @type {string}
     * @memberof InternalTransferScreeningBankModel
     */
    guid?: string;
    /**
    ...
    updated_at?: string;
    /**
     * The identifier of the transfer that was screened.
     * @type {string}
     * @memberof InternalTransferScreeningBankModel
     */
    transfer_guid?: string;
    /**
     * The state of the transfer screening.
     * @type {string}
     * @memberof InternalTransferScreeningBankModel
     */
    state?: InternalTransferScreeningBankModelStateEnum;
    /**
     * The outcome of the transfer screening.
     * @type {string}
     * @memberof InternalTransferScreeningBankModel
     */
    outcome?: InternalTransferScreeningBankModelOutcomeEnum;
    /**
     * The failure code of the transfer screening.
     * @type {string}
     * @memberof InternalTransferScreeningBankModel
     */
    failure_code?: InternalTransferScreeningBankModelFailureCodeEnum;
    /**
     * The hold type requested for the transfer.
     * @type {string}
     * @memberof InternalTransferScreeningBankModel
     */
    hold_requested?: InternalTransferScreeningBankModelHoldRequestedEnum;
    /**
     * The enabled features on the screening.
     * @type {Array<string>}
     * @memberof InternalTransferScreeningBankModel
     */
 ...
 * @enum {string}
 */
export enum InternalTransferScreeningBankModelStateEnum {
    Storing = 'storing',
    Waiting = 'waiting',
    Reviewing = 'reviewing',
    Completed = 'completed'
 ...
 * @enum {string}
 */
export enum InternalTransferScreeningBankModelOutcomeEnum {
    Approved = 'approved',
    Denied = 'denied',
    Failed = 'failed',
    Dismissed = 'dismissed'
 ...
 * @enum {string}
 */
export enum InternalTransferScreeningBankModelFailureCodeEnum {
 ...
 * @enum {string}
 */
export enum InternalTransferScreeningBankModelHoldRequestedEnum {
    None = 'none',
