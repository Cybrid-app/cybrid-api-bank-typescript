...
/**
 * @export
 * @interface PostInternalExpectedPaymentBankModel
 */
export interface PostInternalExpectedPaymentBankModel {
    /**
     * The kind of expected payment.
     * @type {string}
     * @memberof PostInternalExpectedPaymentBankModel
     */
    payment_kind: PostInternalExpectedPaymentBankModelPaymentKindEnum;
    /**
     ...
     * @memberof PostInternalExpectedPaymentBankModel
     */
    internal_account_type: PostInternalExpectedPaymentBankModelInternalAccountTypeEnum;
    /**
     * The identifier of the exchange settlement that this payment is associated with.
     * @type {string}
     * @memberof PostInternalExpectedPaymentBankModel
     */
    exchange_settlement_guid?: string | null;
    /**
     ...
     * @memberof PostInternalExpectedPaymentBankModel
     */
    environment?: PostInternalExpectedPaymentBankModelEnvironmentEnum;
    /**
 ...
 * @enum {string}
 */
export enum PostInternalExpectedPaymentBankModelPaymentKindEnum {
    GasPayment = 'gas_payment',
    GasSettlement = 'gas_settlement',
    PlatformPayment = 'platform_payment',
    ExchangeSettlement = 'exchange_settlement'
}
/**
 * @export
 * @enum {string}
 */
export enum PostInternalExpectedPaymentBankModelInternalAccountTypeEnum {
 ...
 * @enum {string}
 */
export enum PostInternalExpectedPaymentBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
