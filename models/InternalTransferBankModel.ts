...
import type {
    InternalTransferDestinationAccountBankModel,
    InternalTransferSourceAccountBankModel,
    TransferParticipantBankModel,
} from './';

/**
 * @export
 * @interface InternalTransferBankModel
 */
export interface InternalTransferBankModel {
    /**
     * Auto-generated unique identifier for the transfer.
     * @type {string}
     * @memberof InternalTransferBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalTransferBankModel
     */
    transfer_type?: InternalTransferBankModelTransferTypeEnum;
    /**
     ...
     * @memberof InternalTransferBankModel
     */
    side?: InternalTransferBankModelSideEnum;
    /**
     * The transfer\'s state
     * @type {string}
     * @memberof InternalTransferBankModel
     */
    state?: InternalTransferBankModelStateEnum;
    /**
     ...
     * @memberof InternalTransferBankModel
     */
    network_fee_liability_amount?: number | null;
    /**
    ...
    /**
     * @type {InternalTransferSourceAccountBankModel}
     * @memberof InternalTransferBankModel
     */
    source_account?: InternalTransferSourceAccountBankModel | null;
    /**
     * The source participants for the transfer.
     * @type {Array<TransferParticipantBankModel>}
     * @memberof InternalTransferBankModel
     */
    source_participants?: Array<TransferParticipantBankModel> | null;
    /**
     * @type {InternalTransferDestinationAccountBankModel}
     * @memberof InternalTransferBankModel
     */
    destination_account?: InternalTransferDestinationAccountBankModel | null;
    /**
 ...
 * @enum {string}
 */
export enum InternalTransferBankModelTransferTypeEnum {
    Funding = 'funding',
    Book = 'book',
    Crypto = 'crypto',
    InternalBankRebalance = 'internal_bank_rebalance',
    InternalWalletRebalance = 'internal_wallet_rebalance',
    ...
    Lightning = 'lightning',
    InstantFundingReturn = 'instant_funding_return'
}
/**
 * @export
 * @enum {string}
 */
export enum InternalTransferBankModelSideEnum {
    Deposit = 'deposit',
 ...
 * @enum {string}
 */
export enum InternalTransferBankModelStateEnum {
    Storing = 'storing',
    Pending = 'pending',
    Reviewing = 'reviewing',
    Completed = 'completed',
