...
/**
 * @export
 * @interface PostInternalComplianceDecisionBankModel
 */
export interface PostInternalComplianceDecisionBankModel {
    /**
     * The compliance decision\'s type
     * @type {string}
     * @memberof PostInternalComplianceDecisionBankModel
     */
    type: PostInternalComplianceDecisionBankModelTypeEnum;
    /**
     ...
     * @memberof PostInternalComplianceDecisionBankModel
     */
    outcome: PostInternalComplianceDecisionBankModelOutcomeEnum;
    /**
     * The reason codes explaining the outcome.
     * @type {Array<string>}
     * @memberof PostInternalComplianceDecisionBankModel
     */
    failure_codes?: Array<PostInternalComplianceDecisionBankModelFailureCodesEnum>;
}
 ...
 * @enum {string}
 */
export enum PostInternalComplianceDecisionBankModelTypeEnum {
    ...
    BusinessAttested = 'business_attested',
 ...
 * @enum {string}
 */
export enum PostInternalComplianceDecisionBankModelOutcomeEnum {
    Passed = 'passed',
    Failed = 'failed'
}
/**
 ...
 * @enum {string}
 */
export enum PostInternalComplianceDecisionBankModelFailureCodesEnum {
    RequestedFailure = 'requested_failure',
    IdCheckFailure = 'id_check_failure',
    IdQualityCheckFailure = 'id_quality_check_failure',
    IdMrzCheckFailure = 'id_mrz_check_failure',
    IdBarcodeCheckFailure = 'id_barcode_check_failure',
    IdPresenceCheckFailure = 'id_presence_check_failure',
    IdExpirationCheckFailure = 'id_expiration_check_failure',
    IdDoubleSideCheckFailure = 'id_double_side_check_failure',
    IdTypeAllowedCheckFailure = 'id_type_allowed_check_failure',
    IdCountryAllowedCheckFailure = 'id_country_allowed_check_failure',
    IdDigitalReplicaCheckFailure = 'id_digital_replica_check_failure',
    IdPaperReplicaCheckFailure = 'id_paper_replica_check_failure',
    DatabaseCheckFailure = 'database_check_failure',
    SelfieFailure = 'selfie_failure',
    SelfiePoseCheckFailure = 'selfie_pose_check_failure',
    SelfieQualityCheckFailure = 'selfie_quality_check_failure',
    PepCheckFailure = 'pep_check_failure',
    MediaCheckFailure = 'media_check_failure',
    WatchlistCheckFailure = 'watchlist_check_failure',
    BannedNameCheckFailure = 'banned_name_check_failure',
    ProhibitedPersonCheckFailure = 'prohibited_person_check_failure',
    BannedIpAddressCheckFailure = 'banned_ip_address_check_failure',
    CountryComparisonCheckFailure = 'country_comparison_check_failure',
    DuplicatePersonCheckFailure = 'duplicate_person_check_failure',
    NameCheckFailure = 'name_check_failure',
    AddressCheckFailure = 'address_check_failure',
    AccountNumberCheckFailure = 'account_number_check_failure',
    DobCheckFailure = 'dob_check_failure',
    IdNumberCheckFailure = 'id_number_check_failure',
    PhoneNumberCheckFailure = 'phone_number_check_failure',
    EmailAddressCheckFailure = 'email_address_check_failure',
    DocumentTypeCheckFailure = 'document_type_check_failure',
    DocumentQualityCheckFailure = 'document_quality_check_failure',
    DecisionTimeout = 'decision_timeout',
    ComplianceRejection = 'compliance_rejection',
    PlaidFailure = 'plaid_failure',
    PlaidItemLoginRequired = 'plaid_item_login_required',
    PlaidInvalidProduct = 'plaid_invalid_product',
    PlaidItemNotFound = 'plaid_item_not_found',
