...
/**
 * @export
 * @interface InternalPayoutSymbolConfigurationBankModel
 */
export interface InternalPayoutSymbolConfigurationBankModel {
    /**
     * Auto-generated unique identifier for the configuration.
     * @type {string}
     * @memberof InternalPayoutSymbolConfigurationBankModel
     */
    guid?: string;
    /**
     * The type of symbol configuration: bank or platform.
     * @type {string}
     * @memberof InternalPayoutSymbolConfigurationBankModel
     */
    type?: InternalPayoutSymbolConfigurationBankModelTypeEnum;
    /**
     * The environment the configuration is associated with.
     * @type {string}
     * @memberof InternalPayoutSymbolConfigurationBankModel
     */
    environment?: InternalPayoutSymbolConfigurationBankModelEnvironmentEnum;
    /**
     ...
     * @memberof InternalPayoutSymbolConfigurationBankModel
     */
    participants_type?: InternalPayoutSymbolConfigurationBankModelParticipantsTypeEnum;
    /**
     * The route the symbol is enabled for.
     * @type {string}
     * @memberof InternalPayoutSymbolConfigurationBankModel
     */
    route?: InternalPayoutSymbolConfigurationBankModelRouteEnum;
    /**
 ...
 * @enum {string}
 */
export enum InternalPayoutSymbolConfigurationBankModelTypeEnum {
    Platform = 'platform',
    Bank = 'bank'
}
/**
 ...
 * @enum {string}
 */
export enum InternalPayoutSymbolConfigurationBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalPayoutSymbolConfigurationBankModelParticipantsTypeEnum {
    C2C = 'C2C',
    C2B = 'C2B',
    B2C = 'B2C',
    B2B = 'B2B'
 ...
 * @enum {string}
 */
export enum InternalPayoutSymbolConfigurationBankModelRouteEnum {
