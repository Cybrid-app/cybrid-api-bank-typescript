...
import type {
    ...
    IdentityVerificationWithDetailsPiiRegisteredAddressBankModel,
} from './';
...
export interface IdentityVerificationWithDetailsPiiBankModel {
    ...
    /**
     * @type {IdentityVerificationWithDetailsPiiRegisteredAddressBankModel}
     * @memberof IdentityVerificationWithDetailsPiiBankModel
     */
    registered_address?: IdentityVerificationWithDetailsPiiRegisteredAddressBankModel | null;
    /**
     ...
     * @memberof IdentityVerificationWithDetailsPiiBankModel
     */
    business_funds_source?: string | null;
    /**
     * The attested business funds destination.
     * @type {string}
     * @memberof IdentityVerificationWithDetailsPiiBankModel
     */
    business_funds_destination?: string | null;
    /**
     * The attested business type.
     * @type {string}
     * @memberof IdentityVerificationWithDetailsPiiBankModel
     */
    business_type?: IdentityVerificationWithDetailsPiiBankModelBusinessTypeEnum;
    /**
     * The attested business incorporation date.
     * @type {string}
     * @memberof IdentityVerificationWithDetailsPiiBankModel
     */
    business_incorporation_date?: string | null;
    /**
 ...
 * @enum {string}
 */
export enum IdentityVerificationWithDetailsPiiBankModelBusinessTypeEnum {
    Entity = 'entity',
