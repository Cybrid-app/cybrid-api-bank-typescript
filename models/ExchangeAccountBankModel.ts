...
/**
 * @export
 * @interface ExchangeAccountBankModel
 */
export interface ExchangeAccountBankModel {
    /**
     * The exchange account type.
     * @type {string}
     * @memberof ExchangeAccountBankModel
     */
    type?: ExchangeAccountBankModelTypeEnum;
    /**
 ...
 * @enum {string}
 */
export enum ExchangeAccountBankModelTypeEnum {
    Fiat = 'fiat',
    Crypto = 'crypto'
}
