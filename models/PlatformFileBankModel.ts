...
/**
 * @export
 * @interface PlatformFileBankModel
 */
export interface PlatformFileBankModel {
    /**
     * The unique identifier for the file.
     * @type {string}
     * @memberof PlatformFileBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof PlatformFileBankModel
     */
    file_type?: PlatformFileBankModelFileTypeEnum;
    /**
     * The media type; one of image/jpeg, image/png, or application/pdf.
     * @type {string}
     * @memberof PlatformFileBankModel
     */
    content_type?: PlatformFileBankModelContentTypeEnum;
    /**
     ...
     * @memberof PlatformFileBankModel
     */
    state?: PlatformFileBankModelStateEnum;
    /**
 ...
 * @enum {string}
 */
export enum PlatformFileBankModelFileTypeEnum {
 ...
 * @enum {string}
 */
export enum PlatformFileBankModelContentTypeEnum {
 ...
 * @enum {string}
 */
export enum PlatformFileBankModelStateEnum {
    Storing = 'storing',
    Completed = 'completed',
    Failed = 'failed'
}
