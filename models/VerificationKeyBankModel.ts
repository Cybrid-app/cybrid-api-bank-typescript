...
export interface VerificationKeyBankModel {
     ...
     * @memberof VerificationKeyBankModel
     */
    type?: VerificationKeyBankModelTypeEnum;
    /**
     * The verification key\'s state.
     * @type {string}
     * @memberof VerificationKeyBankModel
     */
    state?: VerificationKeyBankModelStateEnum;
    /**
     * The verification key\'s failure code (if any).
     * @type {string}
     * @memberof VerificationKeyBankModel
     */
    failure_code?: VerificationKeyBankModelFailureCodeEnum;
    /**
     * The verification key\'s algorithm.
     * @type {string}
     * @memberof VerificationKeyBankModel
     */
    algorithm?: VerificationKeyBankModelAlgorithmEnum;
    /**
 ...
 * @enum {string}
 */
export enum VerificationKeyBankModelTypeEnum {
 ...
 * @enum {string}
 */
export enum VerificationKeyBankModelStateEnum {
    Storing = 'storing',
    Pending = 'pending',
    Verified = 'verified',
    Failed = 'failed'
 ...
 * @enum {string}
 */
export enum VerificationKeyBankModelFailureCodeEnum {
 ...
 * @enum {string}
 */
export enum VerificationKeyBankModelAlgorithmEnum {
    Rs512 = 'RS512'
}
