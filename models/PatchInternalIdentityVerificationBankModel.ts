...
/**
 * @export
 * @interface PatchInternalIdentityVerificationBankModel
 */
export interface PatchInternalIdentityVerificationBankModel {
    /**
     * ISO8601 datetime the identity verification was started at.
     * @type {string}
     * @memberof PatchInternalIdentityVerificationBankModel
     */
    started_at?: string;
    /**
     ...
     * @memberof PatchInternalIdentityVerificationBankModel
     */
    outcome?: PatchInternalIdentityVerificationBankModelOutcomeEnum;
    /**
     * The reason codes explaining the outcome.
     * @type {Array<string>}
     * @memberof PatchInternalIdentityVerificationBankModel
     */
    failure_codes?: Array<PatchInternalIdentityVerificationBankModelFailureCodesEnum>;
    /**
 ...
 * @enum {string}
 */
export enum PatchInternalIdentityVerificationBankModelOutcomeEnum {
    Passed = 'passed',
    Failed = 'failed'
}
/**
 ...
 * @enum {string}
 */
export enum PatchInternalIdentityVerificationBankModelFailureCodesEnum {
