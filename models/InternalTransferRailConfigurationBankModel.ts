...
/**
 * @export
 * @interface InternalTransferRailConfigurationBankModel
 */
export interface InternalTransferRailConfigurationBankModel {
    /**
     * Auto-generated unique identifier for the configuration.
     * @type {string}
     * @memberof InternalTransferRailConfigurationBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalTransferRailConfigurationBankModel
     */
    type?: InternalTransferRailConfigurationBankModelTypeEnum;
    /**
     * The environment the configuration is associated with.
     * @type {string}
     * @memberof InternalTransferRailConfigurationBankModel
     */
    environment?: InternalTransferRailConfigurationBankModelEnvironmentEnum;
    /**
    ...
    /**
     * The amount of time that the transfer funds should be held, in seconds.
     * @type {number}
     * @memberof InternalTransferRailConfigurationBankModel
     */
     ...
     * @memberof InternalTransferRailConfigurationBankModel
     */
    rail?: InternalTransferRailConfigurationBankModelRailEnum;
    /**
 ...
 * @enum {string}
 */
export enum InternalTransferRailConfigurationBankModelTypeEnum {
    Platform = 'platform',
    Bank = 'bank'
}
/**
 ...
 * @enum {string}
 */
export enum InternalTransferRailConfigurationBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalTransferRailConfigurationBankModelRailEnum {
    Ach = 'ach',
    Eft = 'eft',
    Rtp = 'rtp',
    Wire = 'wire',
