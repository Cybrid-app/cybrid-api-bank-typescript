...
/**
 * @export
 * @interface PostVerificationKeyBankModel
 */
export interface PostVerificationKeyBankModel {
    /**
     * The verification key\'s type.
     * @type {string}
     * @memberof PostVerificationKeyBankModel
     */
    type: PostVerificationKeyBankModelTypeEnum;
    /**
     * The verification key\'s algorithm.
     * @type {string}
     * @memberof PostVerificationKeyBankModel
     */
    algorithm: PostVerificationKeyBankModelAlgorithmEnum;
    /**
 ...
 * @enum {string}
 */
export enum PostVerificationKeyBankModelTypeEnum {
 ...
 * @enum {string}
 */
export enum PostVerificationKeyBankModelAlgorithmEnum {
    Rs512 = 'RS512'
}
