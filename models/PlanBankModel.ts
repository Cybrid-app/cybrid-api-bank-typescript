...
export interface PlanBankModel {
     ...
     * @type {Array<IntermediateAccountBankModel>}
     * @memberof PlanBankModel
     */
     ...
     * @memberof PlanBankModel
     */
    purpose_of_transaction?: PlanBankModelPurposeOfTransactionEnum;
    /**
     * Supporting documents attached to the plan. Optional when type is remittance or type is invoice_pay.
     * @type {Array<SupportingDocumentBankModel>}
     * @memberof PlanBankModel
     */
    supporting_documents?: Array<SupportingDocumentBankModel> | null;
    /**
 ...
 * @enum {string}
 */
export enum PlanBankModelPurposeOfTransactionEnum {
