...
import type {
    ...
    PayoutReturnDetailsBankModel,
    ReturnDetailsBankModel,
    StageIdentifierBankModel,
    StageLinkBankModel,
} from './';

/**
 * @export
 * @interface StageBankModel
 */
export interface StageBankModel {
    /**
     * The unique identifier for the stage.
     * @type {string}
     * @memberof StageBankModel
     */
    guid: string;
    /**
    ...
    /**
     * @type {PayoutReturnDetailsBankModel}
     * @memberof StageBankModel
     */
