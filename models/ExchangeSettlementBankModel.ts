...
export interface ExchangeSettlementBankModel {
     ...
     * @memberof ExchangeSettlementBankModel
     */
    state?: ExchangeSettlementBankModelStateEnum;
    /**
 ...
 * @enum {string}
 */
export enum ExchangeSettlementBankModelStateEnum {
    Storing = 'storing',
    PendingCreated = 'pending__created',
    PendingApproved = 'pending__approved',
