...
export interface PostIdentityVerificationBankModel {
     ...
     * @type {Array<PostIdentityVerificationAliasesInnerBankModel>}
     * @memberof PostIdentityVerificationBankModel
     */
     ...
     * @type {Array<PostUltimateBeneficialOwnerBankModel>}
     * @memberof PostIdentityVerificationBankModel
     */
    ...
    /**
     * @type {PostIdentityVerificationRegisteredAddressBankModel}
     * @memberof PostIdentityVerificationBankModel
     */
     ...
     * @memberof PostIdentityVerificationBankModel
     */
    business_industry?: PostIdentityVerificationBankModelBusinessIndustryEnum;
    /**
     ...
     * @memberof PostIdentityVerificationBankModel
     */
    business_type?: PostIdentityVerificationBankModelBusinessTypeEnum;
    /**
...
export enum PostIdentityVerificationBankModelMethodEnum {
    ...
    TaxIdAndSelfie = 'tax_id_and_selfie',
    BusinessRegistration = 'business_registration',
    AttestedIdAndSelfie = 'attested_id_and_selfie',
    AttestedBusinessRegistration = 'attested_business_registration',
    AttestedBusinessAssociate = 'attested_business_associate',
    AttestedIdAndDatabase = 'attested_id_and_database',
    AttestedDatabase = 'attested_database',
    AttestedOwnership = 'attested_ownership',
 ...
 * @enum {string}
 */
export enum PostIdentityVerificationBankModelBusinessIndustryEnum {
    CryptoDigitalAssetsBlockchain = 'crypto_digital_assets_blockchain',
    Education = 'education',
    Gaming = 'gaming',
    HealthcareHospitality = 'healthcare_hospitality',
    LendingInvestments = 'lending_investments',
    LogisticsManufacturingTransportation = 'logistics_manufacturing_transportation',
    MoneyServicesPaymentsRemittance = 'money_services_payments_remittance',
    ConsultingLegalAccounting = 'consulting_legal_accounting',
    RealEstatePropertyManagement = 'real_estate_property_management',
    RetailEcommerce = 'retail_ecommerce',
    SocialMediaContentCreatorInfluencer = 'social_media_content_creator_influencer',
    TechnologySoftwareSaas = 'technology_software_saas',
 ...
 * @enum {string}
 */
export enum PostIdentityVerificationBankModelBusinessTypeEnum {
    Entity = 'entity',
