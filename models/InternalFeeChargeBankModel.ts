 ...
 * @export
 * @interface InternalFeeChargeBankModel
 */
export interface InternalFeeChargeBankModel {
    /**
     * The platform environment.
     * @type {string}
     * @memberof InternalFeeChargeBankModel
     */
    environment: InternalFeeChargeBankModelEnvironmentEnum;
    /**
     ...
     * @memberof InternalFeeChargeBankModel
     */
    type: InternalFeeChargeBankModelTypeEnum;
    /**
     ...
     * @memberof InternalFeeChargeBankModel
     */
    state: InternalFeeChargeBankModelStateEnum;
    /**
     * The failure code if the entity is in a failed state.
     * @type {string}
     * @memberof InternalFeeChargeBankModel
     */
    failure_code?: InternalFeeChargeBankModelFailureCodeEnum;
    /**
     * The exchange order identifier. Required when type is platform_assignment.
     * @type {string}
     * @memberof InternalFeeChargeBankModel
     */
    exchange_order_guid?: string | null;
}
 ...
 * @enum {string}
 */
export enum InternalFeeChargeBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalFeeChargeBankModelTypeEnum {
    PlatformAssignment = 'platform_assignment'
}
/**
 * @export
 * @enum {string}
 */
export enum InternalFeeChargeBankModelStateEnum {
    Storing = 'storing',
    Pending = 'pending',
    Completed = 'completed',
    Failed = 'failed'
 ...
 * @enum {string}
 */
export enum InternalFeeChargeBankModelFailureCodeEnum {
