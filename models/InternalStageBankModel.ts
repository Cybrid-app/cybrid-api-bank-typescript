...
import type {
    ...
    InternalFeeAssociationBankModel,
} from './';

/**
 * 
 * @export
 * @interface InternalStageBankModel
 */
export interface InternalStageBankModel {
    /**
     * The unique identifier for the stage.
     * @type {string}
     * @memberof InternalStageBankModel
     */
    guid: string;
    /**
     * The unique identifier for the associated plan.
     * @type {string}
     * @memberof InternalStageBankModel
     */
    plan_guid: string;
    /**
     * The index of the stage in the plan, starting at 0 for the first stage.
     * @type {number}
     * @memberof InternalStageBankModel
     */
    stage_index: number;
     ...
     * @type {Array<InternalFeeAssociationBankModel>}
     * @memberof InternalStageBankModel
     */
    fees: Array<InternalFeeAssociationBankModel>;
}
