 ...
 * @export
 * @interface PostBankBankModel
 */
export interface PostBankBankModel {
    /**
     * The type of bank.
     * @type {string}
     * @memberof PostBankBankModel
     */
    type: PostBankBankModelTypeEnum;
    /**
     ...
     * @memberof PostBankBankModel
     */
    features: Array<PostBankBankModelFeaturesEnum>;
    /**
 ...
 * @enum {string}
 */
export enum PostBankBankModelTypeEnum {
    Sandbox = 'sandbox'
}
/**
 * @export
 * @enum {string}
 */
export enum PostBankBankModelFeaturesEnum {
