...
/**
 * @export
 * @interface CounterpartyBankModel
 */
export interface CounterpartyBankModel {
    /**
     * Auto-generated unique identifier for the counterparty.
     * @type {string}
     * @memberof CounterpartyBankModel
     */
    guid?: string;
    /**
    ...
    state?: string;
    /**
     * @type {CounterpartyNameBankModel}
     * @memberof CounterpartyBankModel
     */
    name?: CounterpartyNameBankModel | null;
    /**
     * @type {CounterpartyAddressBankModel}
     * @memberof CounterpartyBankModel
     */
    address?: CounterpartyAddressBankModel | null;
    /**
     * The counterparty\'s aliases. Only available for GET operations when \'include_pii\' is set.
     * @type {Array<CounterpartyAliasesInnerBankModel>}
     * @memberof CounterpartyBankModel
     */
    aliases?: Array<CounterpartyAliasesInnerBankModel> | null;
    /**
