...
import type {
    InternalActivityLimitBankModel,
} from './';

/**
 * @export
 * @interface InternalActivityLimitConfigurationBankModel
 */
export interface InternalActivityLimitConfigurationBankModel {
    /**
     * Auto-generated unique identifier for the configuration.
     * @type {string}
     * @memberof InternalActivityLimitConfigurationBankModel
     */
    guid?: string;
    /**
     * The type of configuration; one of platform, bank, or customer.
     * @type {string}
     * @memberof InternalActivityLimitConfigurationBankModel
     */
    type?: InternalActivityLimitConfigurationBankModelTypeEnum;
    /**
     * The (optional) activity the configuration is associated with; one of trading, funding, book_transfer, or crypto_transfer.
     * @type {string}
     * @memberof InternalActivityLimitConfigurationBankModel
     */
    activity?: InternalActivityLimitConfigurationBankModelActivityEnum;
    /**
     * The (optional) side the configuration is associated with; one of deposit or withdrawal.
     * @type {string}
     * @memberof InternalActivityLimitConfigurationBankModel
     */
    side?: InternalActivityLimitConfigurationBankModelSideEnum;
    /**
     * The environment the configuration is associated with.
     * @type {string}
     * @memberof InternalActivityLimitConfigurationBankModel
     */
    environment?: InternalActivityLimitConfigurationBankModelEnvironmentEnum;
    /**
    ...
    /**
     * The customer identifier that the configuration is associated with.
     * @type {string}
     * @memberof InternalActivityLimitConfigurationBankModel
     */
     ...
     * @memberof InternalActivityLimitConfigurationBankModel
     */
    audience?: InternalActivityLimitConfigurationBankModelAudienceEnum;
    /**
     * The ISO 3166 country 2-Alpha country code the configuration.
     * @type {string}
     * @memberof InternalActivityLimitConfigurationBankModel
     */
     ...
     * @type {Array<InternalActivityLimitBankModel>}
     * @memberof InternalActivityLimitConfigurationBankModel
     */
    limits?: Array<InternalActivityLimitBankModel>;
    /**
 ...
 * @enum {string}
 */
export enum InternalActivityLimitConfigurationBankModelTypeEnum {
    Platform = 'platform',
    Bank = 'bank',
    Customer = 'customer'
}
 ...
 * @enum {string}
 */
export enum InternalActivityLimitConfigurationBankModelActivityEnum {
    Trading = 'trading',
    Funding = 'funding',
 ...
 * @enum {string}
 */
export enum InternalActivityLimitConfigurationBankModelSideEnum {
    Deposit = 'deposit',
 ...
 * @enum {string}
 */
export enum InternalActivityLimitConfigurationBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum InternalActivityLimitConfigurationBankModelAudienceEnum {
    IndividualTaxIdVerifiedCustomer = 'individual_tax_id_verified_customer',
    IndividualTaxIdUnverifiedCustomer = 'individual_tax_id_unverified_customer',
