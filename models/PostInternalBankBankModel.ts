 ...
 * @export
 * @interface PostInternalBankBankModel
 */
export interface PostInternalBankBankModel {
    /**
     * The organization GUID for which to create the bank.
     * @type {string}
     * @memberof PostInternalBankBankModel
     */
     ...
     * @memberof PostInternalBankBankModel
     */
    type: PostInternalBankBankModelTypeEnum;
    /**
     ...
     * @type {Array<PostSupportedPayoutSymbolsBankModel>}
     * @memberof PostInternalBankBankModel
     */
    supported_payout_symbols?: Array<PostSupportedPayoutSymbolsBankModel> | null;
    /**
     ...
     * @memberof PostInternalBankBankModel
     */
    features: Array<PostInternalBankBankModelFeaturesEnum>;
    /**
     * The list of allowed CORS origin URIs.
     * @type {Array<string>}
     * @memberof PostInternalBankBankModel
     */
    cors_allowed_origins?: Array<string> | null;
    /**
     * The persona theme ID for the bank.
     * @type {string}
     * @memberof PostInternalBankBankModel
     */
    persona_theme_id?: string | null;
}
 ...
 * @enum {string}
 */
export enum PostInternalBankBankModelTypeEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum PostInternalBankBankModelFeaturesEnum {
    AttestationIdentityRecords = 'attestation_identity_records',
    AttestationIdentityRecordsV2 = 'attestation_identity_records_v2',
    ...
    CounterpartyExternalAccounts = 'counterparty_external_accounts'
}
