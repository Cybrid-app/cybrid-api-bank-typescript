...
/**
 * @export
 * @interface InternalCountryCodeConfigurationBankModel
 */
export interface InternalCountryCodeConfigurationBankModel {
    /**
     * Auto-generated unique identifier for the configuration.
     * @type {string}
     * @memberof InternalCountryCodeConfigurationBankModel
     */
    guid?: string;
    /**
     ...
     * @memberof InternalCountryCodeConfigurationBankModel
     */
    type?: InternalCountryCodeConfigurationBankModelTypeEnum;
    /**
     * The environment the configuration is associated with.
     * @type {string}
     * @memberof InternalCountryCodeConfigurationBankModel
     */
    environment?: InternalCountryCodeConfigurationBankModelEnvironmentEnum;
    /**
 ...
 * @enum {string}
 */
export enum InternalCountryCodeConfigurationBankModelTypeEnum {
    Platform = 'platform',
    Bank = 'bank'
}
/**
 ...
 * @enum {string}
 */
export enum InternalCountryCodeConfigurationBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
