 ...
 * @export
 * @interface PostBankAccountDetailsBankModel
 */
export interface PostBankAccountDetailsBankModel {
    /**
     * The bank code.
     * @type {string}
     * @memberof PostBankAccountDetailsBankModel
     */
     ...
     * @memberof PostBankAccountDetailsBankModel
     */
    account_identifier_type?: PostBankAccountDetailsBankModelAccountIdentifierTypeEnum;
    /**
     * The payment rail used for the account.
     * @type {string}
     * @memberof PostBankAccountDetailsBankModel
     */
    payment_rail: PostBankAccountDetailsBankModelPaymentRailEnum;
    /**
 ...
 * @enum {string}
 */
export enum PostBankAccountDetailsBankModelAccountIdentifierTypeEnum {
    Clabe = 'CLABE',
 ...
 * @enum {string}
 */
export enum PostBankAccountDetailsBankModelPaymentRailEnum {
    Eft = 'EFT',
    Ach = 'ACH',
    Rtp = 'RTP',
    Fednow = 'FEDNOW',
 ...
 * @enum {string}
 */
export enum PostBankAccountDetailsBankModelBankCodeTypeEnum {
    Cpa = 'CPA',
    Aba = 'ABA',
    Clabe = 'CLABE',
    Pix = 'PIX',
 ...
 * @enum {string}
 */
export enum PostBankAccountDetailsBankModelAccountTypeEnum {
    Checking = 'checking',
    Savings = 'savings'
}
/**
 ...
 * @enum {string}
 */
export enum PostBankAccountDetailsBankModelAccountDesignationEnum {
    Nre = 'NRE',
    Nro = 'NRO'
}
