...
import type {
    ...
    PostPlanIntermediateAccountsInnerBankModel,
    PostPlanSourceAccountBankModel,
    PostPlanTravelRuleInfoBankModel,
    PostSupportingDocumentBankModel,
} from './';

/**
 * Request body for plan creation.
 * @export
 * @interface PostPlanBankModel
 */
export interface PostPlanBankModel {
    /**
     * The type of product the plan is for.
     * @type {string}
     * @memberof PostPlanBankModel
     */
    type: PostPlanBankModelTypeEnum;
    /**
    ...
    /**
     * @type {PostPlanSourceAccountBankModel}
     * @memberof PostPlanBankModel
     */
    source_account: PostPlanSourceAccountBankModel;
    /**
     * @type {PostPlanDestinationAccountBankModel}
     * @memberof PostPlanBankModel
     */
     ...
     * @type {Array<PostPlanIntermediateAccountsInnerBankModel>}
     * @memberof PostPlanBankModel
     */
    intermediate_accounts?: Array<PostPlanIntermediateAccountsInnerBankModel> | null;
    /**
     * @type {PostPlanTravelRuleInfoBankModel}
     * @memberof PostPlanBankModel
     */
    travel_rule_info?: PostPlanTravelRuleInfoBankModel | null;
    /**
     * The purpose of transaction for the plan.
     * @type {string}
     * @memberof PostPlanBankModel
     */
    purpose_of_transaction?: PostPlanBankModelPurposeOfTransactionEnum;
    /**
     ...
     * @type {Array<PostSupportingDocumentBankModel>}
     * @memberof PostPlanBankModel
     */
    supporting_documents?: Array<PostSupportingDocumentBankModel> | null;
}
 ...
 * @enum {string}
 */
export enum PostPlanBankModelTypeEnum {
 ...
 * @enum {string}
 */
export enum PostPlanBankModelPurposeOfTransactionEnum {
    ...
    Travel = 'travel',
    HotelAccommodation = 'hotel_accommodation',
    SmallValueRemittance = 'small_value_remittance',
    LiberalizedRemittance = 'liberalized_remittance',
    ...
    SharesInvestment = 'shares_investment',
    FundInvestment = 'fund_investment',
    BillPayment = 'bill_payment',
    TransportationFees = 'transportation_fees',
    SalaryPayment = 'salary_payment',
    RewardPayment = 'reward_payment',
    InfluencerPayment = 'influencer_payment',
    OtherFees = 'other_fees',
    Other = 'other',
    ExportedGoods = 'exported_goods',
    CommissionOnGoods = 'commission_on_goods',
    CommissionOnServices = 'commission_on_services',
    AccountingServices = 'accounting_services',
    ExhibitionServices = 'exhibition_services'
}
