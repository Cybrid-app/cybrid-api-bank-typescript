 ...
 * @export
 * @interface PostInternalExchangeOrderBankModel
 */
export interface PostInternalExchangeOrderBankModel {
    /**
     * The environment for the configuration.
     * @type {string}
     * @memberof PostInternalExchangeOrderBankModel
     */
    environment: PostInternalExchangeOrderBankModelEnvironmentEnum;
    /**
     * The order type.
     * @type {string}
     * @memberof PostInternalExchangeOrderBankModel
     */
    type: PostInternalExchangeOrderBankModelTypeEnum;
    /**
     ...
     * @memberof PostInternalExchangeOrderBankModel
     */
    side?: PostInternalExchangeOrderBankModelSideEnum;
    /**
     ...
     * @memberof PostInternalExchangeOrderBankModel
     */
    source_payable_account_guid?: string | null;
    /**
     * The source receivable account guid to use for the order
     * @type {string}
     * @memberof PostInternalExchangeOrderBankModel
     */
    source_receivable_account_guid?: string | null;
    /**
     * The side to fix Optional when type is fixed.
     * @type {string}
     * @memberof PostInternalExchangeOrderBankModel
     */
    fixed_amount?: PostInternalExchangeOrderBankModelFixedAmountEnum;
}
 ...
 * @enum {string}
 */
export enum PostInternalExchangeOrderBankModelEnvironmentEnum {
    Sandbox = 'sandbox',
 ...
 * @enum {string}
 */
export enum PostInternalExchangeOrderBankModelTypeEnum {
    Fixed = 'fixed'
}
/**
 * @export
 * @enum {string}
 */
export enum PostInternalExchangeOrderBankModelSideEnum {
    Buy = 'buy',
    Sell = 'sell'
}
/**
 ...
 * @enum {string}
 */
export enum PostInternalExchangeOrderBankModelFixedAmountEnum {
    Deliver = 'deliver',
    Receive = 'receive'
}
