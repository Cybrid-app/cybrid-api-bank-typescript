...
/**
 * @export
 * @interface InternalReconciliationBankModel
 */
export interface InternalReconciliationBankModel {
    /**
     * The category of the reconciliation
     * @type {string}
     * @memberof InternalReconciliationBankModel
     */
    category?: InternalReconciliationBankModelCategoryEnum;
    /**
     * The confidence of the reconciliation
     * @type {string}
     * @memberof InternalReconciliationBankModel
     */
    confidence?: InternalReconciliationBankModelConfidenceEnum;
    /**
     * The direction of the reconciliation: \"debit\" or \"credit\"
     * @type {string}
     * @memberof InternalReconciliationBankModel
     */
    direction?: InternalReconciliationBankModelDirectionEnum;
    /**
     * The transfer guid associated with the reconciliation
     * @type {string}
     * @memberof InternalReconciliationBankModel
     */
    transfer_guid?: string;
    /**
     * The provider supplied identifier for the reconciliation
     * @type {string}
     * @memberof InternalReconciliationBankModel
     */
 ...
 * @enum {string}
 */
export enum InternalReconciliationBankModelCategoryEnum {
    Transfer = 'transfer',
    Return = 'return'
}
/**
 ...
 * @enum {string}
 */
export enum InternalReconciliationBankModelConfidenceEnum {
    Low = 'low',
    Medium = 'medium',
    High = 'high'
}
 ...
 * @enum {string}
 */
export enum InternalReconciliationBankModelDirectionEnum {
    Debit = 'debit',
    Credit = 'credit'
}
